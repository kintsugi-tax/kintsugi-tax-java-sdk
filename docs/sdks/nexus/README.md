...
public class Application {
    ...
    public static void main(String[] args) throws ErrorResponse, BackendSrcNexusResponsesValidationErrorResponse, ErrorResponse, Exception {
        ...
        GetPhysicalNexusV1NexusPhysicalNexusGetResponse res = sdk.nexus().getPhysicalNexusV1NexusPhysicalNexusGet()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws ErrorResponse, BackendSrcNexusResponsesValidationErrorResponse, ErrorResponse, Exception {
        ...
        CreatePhysicalNexusV1NexusPhysicalNexusPostResponse res = sdk.nexus().createPhysicalNexusV1NexusPhysicalNexusPost()
                .request(req)
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws ErrorResponse, BackendSrcNexusResponsesValidationErrorResponse, ErrorResponse, Exception {
        ...
        UpdatePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdPutResponse res = sdk.nexus().updatePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdPut()
                .physicalNexusId("<id>")
...
public class Application {
    ...
    public static void main(String[] args) throws ErrorResponse, BackendSrcNexusResponsesValidationErrorResponse, ErrorResponse, Exception {
        ...
        DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse res = sdk.nexus().deletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDelete()
                .physicalNexusId("<id>")
                .call();
...
public class Application {
    ...
    public static void main(String[] args) throws HTTPValidationError, Exception {
        ...
        GetNexusForOrgV1NexusGetResponse res = sdk.nexus().getNexusForOrgV1NexusGet()
                .request(req)
                .call();
