...
public class Registrations {
     ...
     */
    public GetRegistrationsV1RegistrationsGetRequestBuilder getRegistrationsV1RegistrationsGet() {
     ...
     */
    public GetRegistrationsV1RegistrationsGetResponse getRegistrationsV1RegistrationsGet(GetRegistrationsV1RegistrationsGetRequest request) throws Exception {
     ...
     * @return The call builder
     */
    public CreateRegistrationV1RegistrationsPostRequestBuilder createRegistrationV1RegistrationsPost() {
     ...
     * @throws Exception if the API call fails
     */
    public CreateRegistrationV1RegistrationsPostResponse createRegistrationV1RegistrationsPost(CreateRegistration request) throws Exception {
     ...
     * @return The call builder
     */
    public GetRegistrationByIdV1RegistrationsRegistrationIdGetRequestBuilder getRegistrationByIdV1RegistrationsRegistrationIdGet() {
     ...
     * @throws Exception if the API call fails
     */
    public GetRegistrationByIdV1RegistrationsRegistrationIdGetResponse getRegistrationByIdV1RegistrationsRegistrationIdGet(String registrationId) throws Exception {
     ...
     * @return The call builder
     */
    public UpdateRegistrationV1RegistrationsRegistrationIdPutRequestBuilder updateRegistrationV1RegistrationsRegistrationIdPut() {
     ...
     * @throws Exception if the API call fails
     */
    public UpdateRegistrationV1RegistrationsRegistrationIdPutResponse updateRegistrationV1RegistrationsRegistrationIdPut(String registrationId, RegistrationUpdateAPI registrationUpdateAPI) throws Exception {
     ...
     * @return The call builder
     */
    public DeregisterRegistrationV1RegistrationsRegistrationIdDeregisterPostRequestBuilder deregisterRegistrationV1RegistrationsRegistrationIdDeregisterPost() {
     ...
     * @throws Exception if the API call fails
     */
    public DeregisterRegistrationV1RegistrationsRegistrationIdDeregisterPostResponse deregisterRegistrationV1RegistrationsRegistrationIdDeregisterPost(String registrationId) throws Exception {
