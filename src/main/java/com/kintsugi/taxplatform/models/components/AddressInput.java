...
public class AddressInput {
    ...
    public AddressInput withId(String id) {
        Utils.checkNotNull(id, "id");
    ...
    public AddressInput withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Timestamp when transaction was created in Kintsugi.
     */
    public AddressInput withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * Timestamp when transaction was created in Kintsugi.
     */
    public AddressInput withCreatedAt(Optional<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * Timestamp when transaction was last updated.
     */
    public AddressInput withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
     ...
     * Timestamp when transaction was last updated.
     */
    public AddressInput withUpdatedAt(JsonNullable<OffsetDateTime> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * Phone number associated with the address.
     */
    public AddressInput withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * Phone number associated with the address.
     */
    public AddressInput withPhone(JsonNullable<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * Primary street address.
     */
    public AddressInput withStreet1(String street1) {
        Utils.checkNotNull(street1, "street1");
     ...
     * Primary street address.
     */
    public AddressInput withStreet1(JsonNullable<String> street1) {
        Utils.checkNotNull(street1, "street1");
        this.street1 = street1;
        return this;
    }
     ...
     * Additional street address details, such as an apartment or suite number.
     */
    public AddressInput withStreet2(String street2) {
        Utils.checkNotNull(street2, "street2");
     ...
     * Additional street address details, such as an apartment or suite number.
     */
    public AddressInput withStreet2(JsonNullable<String> street2) {
        Utils.checkNotNull(street2, "street2");
        this.street2 = street2;
        return this;
    }
     ...
     * City where the customer resides.
     */
    public AddressInput withCity(JsonNullable<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * County or district of the customer.
     */
    public AddressInput withCounty(String county) {
        Utils.checkNotNull(county, "county");
     ...
     * County or district of the customer.
     */
    public AddressInput withCounty(JsonNullable<String> county) {
        Utils.checkNotNull(county, "county");
        this.county = county;
        return this;
    }
     ...
     * State or province of the customer.
     */
    public AddressInput withState(String state) {
        Utils.checkNotNull(state, "state");
     ...
     * State or province of the customer.
     */
    public AddressInput withState(JsonNullable<String> state) {
        Utils.checkNotNull(state, "state");
        this.state = state;
        return this;
    }
     ...
     * ZIP or Postal code of the customer.
     */
    public AddressInput withPostalCode(JsonNullable<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * Country code in ISO 3166-1 alpha-2 format
     */
    public AddressInput withCountry(CountryCodeEnum country) {
        Utils.checkNotNull(country, "country");
     ...
     * Country code in ISO 3166-1 alpha-2 format
     */
    public AddressInput withCountry(JsonNullable<? extends CountryCodeEnum> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * Complete address string of the customer, which can be used as an alternative to individual fields.
     */
    public AddressInput withFullAddress(String fullAddress) {
        Utils.checkNotNull(fullAddress, "fullAddress");
     ...
     * Complete address string of the customer, which can be used as an alternative to individual fields.
     */
    public AddressInput withFullAddress(JsonNullable<String> fullAddress) {
        Utils.checkNotNull(fullAddress, "fullAddress");
        this.fullAddress = fullAddress;
        return this;
    }

    public AddressInput withType(AddressType type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * Optional additional enriched data for the address.
     */
    public AddressInput withEnrichedFields(String enrichedFields) {
        Utils.checkNotNull(enrichedFields, "enrichedFields");
     ...
     * Optional additional enriched data for the address.
     */
    public AddressInput withEnrichedFields(JsonNullable<String> enrichedFields) {
        Utils.checkNotNull(enrichedFields, "enrichedFields");
        this.enrichedFields = enrichedFields;
        return this;
    }

    public AddressInput withStatus(AddressStatus status) {
        Utils.checkNotNull(status, "status");
    ...
    public AddressInput withStatus(Optional<? extends AddressStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }

    public AddressInput withOrganizationId(String organizationId) {
        Utils.checkNotNull(organizationId, "organizationId");
        this.organizationId = JsonNullable.of(organizationId);
        return this;
    }

    public AddressInput withOrganizationId(JsonNullable<String> organizationId) {
        Utils.checkNotNull(organizationId, "organizationId");
        this.organizationId = organizationId;
        return this;
    }

    public AddressInput withTransactionId(String transactionId) {
        Utils.checkNotNull(transactionId, "transactionId");
        this.transactionId = JsonNullable.of(transactionId);
        return this;
    }

    public AddressInput withTransactionId(JsonNullable<String> transactionId) {
        Utils.checkNotNull(transactionId, "transactionId");
        this.transactionId = transactionId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddressInput other = (AddressInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddressInput.class,
                "id", id,
                "createdAt", createdAt,
                "updatedAt", updatedAt,
                "phone", phone,
