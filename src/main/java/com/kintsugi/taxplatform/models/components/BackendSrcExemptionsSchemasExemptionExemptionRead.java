...
public class BackendSrcExemptionsSchemasExemptionExemptionRead {
    ...
    @JsonCreator
    public BackendSrcExemptionsSchemasExemptionExemptionRead(
    ...
    public BackendSrcExemptionsSchemasExemptionExemptionRead withExemptionType(ExemptionType exemptionType) {
        Utils.checkNotNull(exemptionType, "exemptionType");
        this.exemptionType = exemptionType;
        return this;
    }
     ...
     * The jurisdiction identifier for the exemption
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withJurisdiction(String jurisdiction) {
        Utils.checkNotNull(jurisdiction, "jurisdiction");
     ...
     * The jurisdiction identifier for the exemption
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withJurisdiction(JsonNullable<String> jurisdiction) {
        Utils.checkNotNull(jurisdiction, "jurisdiction");
        this.jurisdiction = jurisdiction;
        return this;
    }
     ...
     * Country code in ISO 3166-1 alpha-2 format (e.g., 'US')
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withCountryCode(CountryCodeEnum countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
     ...
     * Country code in ISO 3166-1 alpha-2 format (e.g., 'US')
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withCountryCode(JsonNullable<? extends CountryCodeEnum> countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
     ...
     * Start date for the exemption validity period (YYYY-MM-DD format)
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withStartDate(LocalDate startDate) {
        Utils.checkNotNull(startDate, "startDate");
        this.startDate = startDate;
        return this;
    }
     ...
     * End date for the exemption validity period (YYYY-MM-DD format)
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withEndDate(LocalDate endDate) {
        Utils.checkNotNull(endDate, "endDate");
     ...
     * End date for the exemption validity period (YYYY-MM-DD format)
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withEndDate(JsonNullable<LocalDate> endDate) {
        Utils.checkNotNull(endDate, "endDate");
        this.endDate = endDate;
        return this;
    }
     ...
     * Unique identifier for the customer associated with the exemption
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withCustomerId(String customerId) {
        Utils.checkNotNull(customerId, "customerId");
     ...
     * Unique identifier for the customer associated with the exemption
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withCustomerId(JsonNullable<String> customerId) {
        Utils.checkNotNull(customerId, "customerId");
        this.customerId = customerId;
        return this;
    }
     ...
     * associated with the exemption, if applicable.
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withTransactionId(String transactionId) {
        Utils.checkNotNull(transactionId, "transactionId");
     ...
     * associated with the exemption, if applicable.
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withTransactionId(JsonNullable<String> transactionId) {
        Utils.checkNotNull(transactionId, "transactionId");
        this.transactionId = transactionId;
        return this;
    }
     ...
     * Indicates whether the exemption is for a reseller
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withReseller(boolean reseller) {
        Utils.checkNotNull(reseller, "reseller");
     ...
     * Indicates whether the exemption is for a reseller
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withReseller(Optional<Boolean> reseller) {
        Utils.checkNotNull(reseller, "reseller");
        this.reseller = reseller;
        return this;
    }
     ...
     * associated with the exemption.
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withFein(String fein) {
        Utils.checkNotNull(fein, "fein");
     ...
     * associated with the exemption.
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withFein(JsonNullable<String> fein) {
        Utils.checkNotNull(fein, "fein");
        this.fein = fein;
        return this;
    }
     ...
     * Sales tax ID for the exemption
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withSalesTaxId(String salesTaxId) {
        Utils.checkNotNull(salesTaxId, "salesTaxId");
     ...
     * Sales tax ID for the exemption
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withSalesTaxId(JsonNullable<String> salesTaxId) {
        Utils.checkNotNull(salesTaxId, "salesTaxId");
        this.salesTaxId = salesTaxId;
        return this;
    }
     ...
     * Defaults to ACTIVE if not provided.
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withStatus(ExemptionStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * Defaults to ACTIVE if not provided.
     */
    public BackendSrcExemptionsSchemasExemptionExemptionRead withStatus(JsonNullable<? extends ExemptionStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }

    public BackendSrcExemptionsSchemasExemptionExemptionRead withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }

    public BackendSrcExemptionsSchemasExemptionExemptionRead withCustomerName(String customerName) {
        Utils.checkNotNull(customerName, "customerName");
        this.customerName = JsonNullable.of(customerName);
        return this;
    }

    public BackendSrcExemptionsSchemasExemptionExemptionRead withCustomerName(JsonNullable<String> customerName) {
        Utils.checkNotNull(customerName, "customerName");
        this.customerName = customerName;
        return this;
    }

    public BackendSrcExemptionsSchemasExemptionExemptionRead withAttachmentId(String attachmentId) {
        Utils.checkNotNull(attachmentId, "attachmentId");
        this.attachmentId = JsonNullable.of(attachmentId);
        return this;
    }

    public BackendSrcExemptionsSchemasExemptionExemptionRead withAttachmentId(JsonNullable<String> attachmentId) {
        Utils.checkNotNull(attachmentId, "attachmentId");
        this.attachmentId = attachmentId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BackendSrcExemptionsSchemasExemptionExemptionRead other = (BackendSrcExemptionsSchemasExemptionExemptionRead) o;
        return 
    ...
    public String toString() {
        return Utils.toString(BackendSrcExemptionsSchemasExemptionExemptionRead.class,
                "exemptionType", exemptionType,
    ...
    public final static class Builder {
        ...
        public BackendSrcExemptionsSchemasExemptionExemptionRead build() {
            if (reseller == null) {
                reseller = _SINGLETON_VALUE_Reseller.value();
            }

            return new BackendSrcExemptionsSchemasExemptionExemptionRead(
                exemptionType, jurisdiction, countryCode,
                startDate, endDate, customerId,
                transactionId, reseller, fein,
                salesTaxId, status, id,
