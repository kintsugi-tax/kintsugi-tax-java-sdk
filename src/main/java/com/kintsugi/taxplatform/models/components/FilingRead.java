...
public class FilingRead {
    ...
    /**
     * What the buyer still owes on purchases after reclaiming input tax. US use tax, or EU/UK
     * reverse-charge VAT minus reclaim. Defaults to 0.00.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    /**
     * Input VAT reclaimed on this filing's purchases. Stored so the return can show the reclaim;
     * amount_use_tax is already net of it.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            filingCategory, isPrepayment, approvedBy,
            approvedAt, issueReason, skipReason,
            cancelledReason, taxType, isRdf,
            amountCalculated, amountAdjusted, amountDiscounts,
            amountFees, amountPenalties, amountTaxCollected,
            amountUseTax, amountInputVatRecoverable, amountSales,
            totalTaxableSales, amount, totalTaxLiability,
            transactionCount, marketplaceTransactionCount, estimatedLineCount,
            internalNotes, recentDetailsReportLink, taxRemitted,
            originalTaxRemitted, returnConfirmationId, paymentConfirmationId,
