 ...
 * 
 * <p>Full payload for Hawaii Revenue Online registration import
 */
public class HawaiiRegistrationPayload {
    /**
    ...
    private Optional<? extends HawaiiRegistrationPayloadAmountFees> amountFees;
    ...
    private HawaiiFields jurisdictionSpecificFields;
    ...
    @JsonCreator
    public HawaiiRegistrationPayload(
            ...
            @JsonProperty("amount_fees") Optional<? extends HawaiiRegistrationPayloadAmountFees> amountFees,
            ...
            @JsonProperty("jurisdiction_specific_fields") HawaiiFields jurisdictionSpecificFields,
    ...
    public HawaiiRegistrationPayload(
            ...
            HawaiiFields jurisdictionSpecificFields) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<HawaiiRegistrationPayloadAmountFees> amountFees() {
        return (Optional<HawaiiRegistrationPayloadAmountFees>) amountFees;
    }
     ...
     */
    @JsonIgnore
    public HawaiiFields jurisdictionSpecificFields() {
     ...
     * The date when the registration was created. Format: YYYY-MM-DD.
     */
    public HawaiiRegistrationPayload withRegistrationDate(LocalDate registrationDate) {
        Utils.checkNotNull(registrationDate, "registrationDate");
     ...
     * The date when the registration was created. Format: YYYY-MM-DD.
     */
    public HawaiiRegistrationPayload withRegistrationDate(JsonNullable<LocalDate> registrationDate) {
        Utils.checkNotNull(registrationDate, "registrationDate");
        this.registrationDate = registrationDate;
        return this;
    }
     ...
     * Email address associated with the registration.
     */
    public HawaiiRegistrationPayload withRegistrationEmail(String registrationEmail) {
        Utils.checkNotNull(registrationEmail, "registrationEmail");
     ...
     * Email address associated with the registration.
     */
    public HawaiiRegistrationPayload withRegistrationEmail(JsonNullable<String> registrationEmail) {
        Utils.checkNotNull(registrationEmail, "registrationEmail");
        this.registrationEmail = registrationEmail;
        return this;
    }
     ...
     * Timestamp when the registration was requested.
     */
    public HawaiiRegistrationPayload withRegistrationRequested(OffsetDateTime registrationRequested) {
        Utils.checkNotNull(registrationRequested, "registrationRequested");
     ...
     * Timestamp when the registration was requested.
     */
    public HawaiiRegistrationPayload withRegistrationRequested(JsonNullable<OffsetDateTime> registrationRequested) {
        Utils.checkNotNull(registrationRequested, "registrationRequested");
        this.registrationRequested = registrationRequested;
        return this;
    }
     ...
     * Timestamp when the registration was completed.
     */
    public HawaiiRegistrationPayload withRegistrationCompleted(OffsetDateTime registrationCompleted) {
        Utils.checkNotNull(registrationCompleted, "registrationCompleted");
     ...
     * Timestamp when the registration was completed.
     */
    public HawaiiRegistrationPayload withRegistrationCompleted(JsonNullable<OffsetDateTime> registrationCompleted) {
        Utils.checkNotNull(registrationCompleted, "registrationCompleted");
        this.registrationCompleted = registrationCompleted;
        return this;
    }
     ...
     * Timestamp when deregistration was requested.
     */
    public HawaiiRegistrationPayload withDeregistrationRequested(OffsetDateTime deregistrationRequested) {
        Utils.checkNotNull(deregistrationRequested, "deregistrationRequested");
     ...
     * Timestamp when deregistration was requested.
     */
    public HawaiiRegistrationPayload withDeregistrationRequested(JsonNullable<OffsetDateTime> deregistrationRequested) {
        Utils.checkNotNull(deregistrationRequested, "deregistrationRequested");
        this.deregistrationRequested = deregistrationRequested;
        return this;
    }
     ...
     * Timestamp when the deregistration was completed.
     */
    public HawaiiRegistrationPayload withDeregistrationCompleted(OffsetDateTime deregistrationCompleted) {
        Utils.checkNotNull(deregistrationCompleted, "deregistrationCompleted");
     ...
     * Timestamp when the deregistration was completed.
     */
    public HawaiiRegistrationPayload withDeregistrationCompleted(JsonNullable<OffsetDateTime> deregistrationCompleted) {
        Utils.checkNotNull(deregistrationCompleted, "deregistrationCompleted");
        this.deregistrationCompleted = deregistrationCompleted;
        return this;
    }
     ...
     * Indicates whether the registration was completed automatically.
     */
    public HawaiiRegistrationPayload withAutoRegistered(boolean autoRegistered) {
        Utils.checkNotNull(autoRegistered, "autoRegistered");
     ...
     * Indicates whether the registration was completed automatically.
     */
    public HawaiiRegistrationPayload withAutoRegistered(JsonNullable<Boolean> autoRegistered) {
        Utils.checkNotNull(autoRegistered, "autoRegistered");
        this.autoRegistered = autoRegistered;
        return this;
    }
     ...
     * If true, do not file for this registration (treated as False by default).
     */
    public HawaiiRegistrationPayload withDoNotFile(boolean doNotFile) {
        Utils.checkNotNull(doNotFile, "doNotFile");
     ...
     * If true, do not file for this registration (treated as False by default).
     */
    public HawaiiRegistrationPayload withDoNotFile(Optional<Boolean> doNotFile) {
        Utils.checkNotNull(doNotFile, "doNotFile");
        this.doNotFile = doNotFile;
        return this;
    }
     ...
     * The tax registration regime (e.g., STANDARD, SIMPLIFIED).
     */
    public HawaiiRegistrationPayload withRegistrationsRegime(RegistrationsRegimeEnum registrationsRegime) {
        Utils.checkNotNull(registrationsRegime, "registrationsRegime");
     ...
     * The tax registration regime (e.g., STANDARD, SIMPLIFIED).
     */
    public HawaiiRegistrationPayload withRegistrationsRegime(JsonNullable<? extends RegistrationsRegimeEnum> registrationsRegime) {
        Utils.checkNotNull(registrationsRegime, "registrationsRegime");
        this.registrationsRegime = registrationsRegime;
        return this;
    }

    public HawaiiRegistrationPayload withChangeRegimeStatus(ChangeRegimeStatusEnum changeRegimeStatus) {
        Utils.checkNotNull(changeRegimeStatus, "changeRegimeStatus");
        this.changeRegimeStatus = JsonNullable.of(changeRegimeStatus);
        return this;
    }

    public HawaiiRegistrationPayload withChangeRegimeStatus(JsonNullable<? extends ChangeRegimeStatusEnum> changeRegimeStatus) {
        Utils.checkNotNull(changeRegimeStatus, "changeRegimeStatus");
        this.changeRegimeStatus = changeRegimeStatus;
        return this;
    }

    public HawaiiRegistrationPayload withCountryCode(CountryCodeEnum countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
     ...
     * The state/province code where the registration applies.
     */
    public HawaiiRegistrationPayload withStateCode(String stateCode) {
        Utils.checkNotNull(stateCode, "stateCode");
        this.stateCode = stateCode;
        return this;
    }
     ...
     * The name of the state/province.
     */
    public HawaiiRegistrationPayload withStateName(String stateName) {
        Utils.checkNotNull(stateName, "stateName");
        this.stateName = stateName;
        return this;
    }

    public HawaiiRegistrationPayload withFilingFrequency(FilingFrequencyEnum filingFrequency) {
        Utils.checkNotNull(filingFrequency, "filingFrequency");
        this.filingFrequency = filingFrequency;
        return this;
    }
     ...
     * annual. Null (default) keeps the standard calendar grid.
     */
    public HawaiiRegistrationPayload withPeriodEndMonth(long periodEndMonth) {
        Utils.checkNotNull(periodEndMonth, "periodEndMonth");
     ...
     * annual. Null (default) keeps the standard calendar grid.
     */
    public HawaiiRegistrationPayload withPeriodEndMonth(JsonNullable<Long> periodEndMonth) {
        Utils.checkNotNull(periodEndMonth, "periodEndMonth");
        this.periodEndMonth = periodEndMonth;
        return this;
    }
     ...
     * Username for accessing tax registration details.
     */
    public HawaiiRegistrationPayload withUsername(String username) {
        Utils.checkNotNull(username, "username");
     ...
     * Username for accessing tax registration details.
     */
    public HawaiiRegistrationPayload withUsername(JsonNullable<String> username) {
        Utils.checkNotNull(username, "username");
        this.username = username;
        return this;
    }
     ...
     * Additional comments related to the registration.
     */
    public HawaiiRegistrationPayload withComment(String comment) {
        Utils.checkNotNull(comment, "comment");
     ...
     * Additional comments related to the registration.
     */
    public HawaiiRegistrationPayload withComment(JsonNullable<String> comment) {
        Utils.checkNotNull(comment, "comment");
        this.comment = comment;
        return this;
    }
     ...
     * The date from which filings should be created. should start (YYYY-MM-DD).
     */
    public HawaiiRegistrationPayload withCreateFilingsFrom(LocalDate createFilingsFrom) {
        Utils.checkNotNull(createFilingsFrom, "createFilingsFrom");
     ...
     * The date from which filings should be created. should start (YYYY-MM-DD).
     */
    public HawaiiRegistrationPayload withCreateFilingsFrom(JsonNullable<LocalDate> createFilingsFrom) {
        Utils.checkNotNull(createFilingsFrom, "createFilingsFrom");
        this.createFilingsFrom = createFilingsFrom;
        return this;
    }
     ...
     * Indicates whether an initial synchronization should be performed.
     */
    public HawaiiRegistrationPayload withInitialSync(boolean initialSync) {
        Utils.checkNotNull(initialSync, "initialSync");
     ...
     * Indicates whether an initial synchronization should be performed.
     */
    public HawaiiRegistrationPayload withInitialSync(JsonNullable<Boolean> initialSync) {
        Utils.checkNotNull(initialSync, "initialSync");
        this.initialSync = initialSync;
        return this;
    }
     ...
     * The amount of fees associated with the registration.
     */
    public HawaiiRegistrationPayload withAmountFees(HawaiiRegistrationPayloadAmountFees amountFees) {
        Utils.checkNotNull(amountFees, "amountFees");
     ...
     * The amount of fees associated with the registration.
     */
    public HawaiiRegistrationPayload withAmountFees(Optional<? extends HawaiiRegistrationPayloadAmountFees> amountFees) {
        Utils.checkNotNull(amountFees, "amountFees");
        this.amountFees = amountFees;
        return this;
    }
     ...
     * Indicates whether a Voluntary Disclosure Agreement (VDA) applies.
     */
    public HawaiiRegistrationPayload withVda(boolean vda) {
        Utils.checkNotNull(vda, "vda");
     ...
     * Indicates whether a Voluntary Disclosure Agreement (VDA) applies.
     */
    public HawaiiRegistrationPayload withVda(JsonNullable<Boolean> vda) {
        Utils.checkNotNull(vda, "vda");
        this.vda = vda;
        return this;
    }
     ...
     * Whether the registration was imported from another system.
     */
    public HawaiiRegistrationPayload withImported(boolean imported) {
        Utils.checkNotNull(imported, "imported");
     ...
     * Whether the registration was imported from another system.
     */
    public HawaiiRegistrationPayload withImported(JsonNullable<Boolean> imported) {
        Utils.checkNotNull(imported, "imported");
        this.imported = imported;
        return this;
    }
     ...
     * The sales tax ID associated with the registration.
     */
    public HawaiiRegistrationPayload withSalesTaxId(String salesTaxId) {
        Utils.checkNotNull(salesTaxId, "salesTaxId");
     ...
     * The sales tax ID associated with the registration.
     */
    public HawaiiRegistrationPayload withSalesTaxId(JsonNullable<String> salesTaxId) {
        Utils.checkNotNull(salesTaxId, "salesTaxId");
        this.salesTaxId = salesTaxId;
        return this;
    }
     ...
     * The Importer of Record (IOR) number associated with the registration.
     */
    public HawaiiRegistrationPayload withIorNumber(String iorNumber) {
        Utils.checkNotNull(iorNumber, "iorNumber");
     ...
     * The Importer of Record (IOR) number associated with the registration.
     */
    public HawaiiRegistrationPayload withIorNumber(JsonNullable<String> iorNumber) {
        Utils.checkNotNull(iorNumber, "iorNumber");
        this.iorNumber = iorNumber;
        return this;
    }
     ...
     * Indicates whether the registration is an SST Import.
     */
    public HawaiiRegistrationPayload withSstImport(boolean sstImport) {
        Utils.checkNotNull(sstImport, "sstImport");
     ...
     * Indicates whether the registration is an SST Import.
     */
    public HawaiiRegistrationPayload withSstImport(JsonNullable<Boolean> sstImport) {
        Utils.checkNotNull(sstImport, "sstImport");
        this.sstImport = sstImport;
        return this;
    }
     ...
     * Organization-level tax ID (e.g., VAT number, Canada Business Number).
     */
    public HawaiiRegistrationPayload withTaxId(String taxId) {
        Utils.checkNotNull(taxId, "taxId");
     ...
     * Organization-level tax ID (e.g., VAT number, Canada Business Number).
     */
    public HawaiiRegistrationPayload withTaxId(JsonNullable<String> taxId) {
        Utils.checkNotNull(taxId, "taxId");
        this.taxId = taxId;
        return this;
    }
     ...
     * The plaintext password for accessing the tax registration account.
     */
    public HawaiiRegistrationPayload withPasswordPlainText(String passwordPlainText) {
        Utils.checkNotNull(passwordPlainText, "passwordPlainText");
     ...
     * The plaintext password for accessing the tax registration account.
     */
    public HawaiiRegistrationPayload withPasswordPlainText(JsonNullable<String> passwordPlainText) {
        Utils.checkNotNull(passwordPlainText, "passwordPlainText");
        this.passwordPlainText = passwordPlainText;
        return this;
    }
     ...
     * Metadata related to the password.
     */
    public HawaiiRegistrationPayload withPasswordMetadataPlainText(String passwordMetadataPlainText) {
        Utils.checkNotNull(passwordMetadataPlainText, "passwordMetadataPlainText");
     ...
     * Metadata related to the password.
     */
    public HawaiiRegistrationPayload withPasswordMetadataPlainText(JsonNullable<String> passwordMetadataPlainText) {
        Utils.checkNotNull(passwordMetadataPlainText, "passwordMetadataPlainText");
        this.passwordMetadataPlainText = passwordMetadataPlainText;
        return this;
    }
     ...
     * State-specific fields for Hawaii Revenue Online registration import.
     */
    public HawaiiRegistrationPayload withJurisdictionSpecificFields(HawaiiFields jurisdictionSpecificFields) {
        Utils.checkNotNull(jurisdictionSpecificFields, "jurisdictionSpecificFields");
        this.jurisdictionSpecificFields = jurisdictionSpecificFields;
        return this;
    }
     ...
     * Optional client-minted id for this confirm attempt.
     */
    public HawaiiRegistrationPayload withRequestId(String requestId) {
        Utils.checkNotNull(requestId, "requestId");
     ...
     * Optional client-minted id for this confirm attempt.
     */
    public HawaiiRegistrationPayload withRequestId(JsonNullable<String> requestId) {
        Utils.checkNotNull(requestId, "requestId");
        this.requestId = requestId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HawaiiRegistrationPayload other = (HawaiiRegistrationPayload) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HawaiiRegistrationPayload.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends HawaiiRegistrationPayloadAmountFees> amountFees = Optional.empty();
         ...
         * The amount of fees associated with the registration.
         */
        public Builder amountFees(HawaiiRegistrationPayloadAmountFees amountFees) {
            Utils.checkNotNull(amountFees, "amountFees");
            this.amountFees = Optional.ofNullable(amountFees);
            return this;
        }
         ...
         * The amount of fees associated with the registration.
         */
        public Builder amountFees(Optional<? extends HawaiiRegistrationPayloadAmountFees> amountFees) {
            Utils.checkNotNull(amountFees, "amountFees");
            this.amountFees = amountFees;
            return this;
        }
         ...
         * State-specific fields for Hawaii Revenue Online registration import.
         */
        public Builder jurisdictionSpecificFields(HawaiiFields jurisdictionSpecificFields) {
            Utils.checkNotNull(jurisdictionSpecificFields, "jurisdictionSpecificFields");
            this.jurisdictionSpecificFields = jurisdictionSpecificFields;
            return this;
        }
        ...
        public HawaiiRegistrationPayload build() {
            if (doNotFile == null) {
                doNotFile = _SINGLETON_VALUE_DoNotFile.value();
            }

            return new HawaiiRegistrationPayload(
