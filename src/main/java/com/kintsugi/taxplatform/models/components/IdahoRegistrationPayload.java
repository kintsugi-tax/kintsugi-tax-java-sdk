 ...
 * 
 * <p>Full payload for Idaho registration import.
 */
public class IdahoRegistrationPayload {
    /**
    ...
    private Optional<? extends IdahoRegistrationPayloadAmountFees> amountFees;
    ...
    private IdahoFields jurisdictionSpecificFields;
    ...
    @JsonCreator
    public IdahoRegistrationPayload(
            ...
            @JsonProperty("amount_fees") Optional<? extends IdahoRegistrationPayloadAmountFees> amountFees,
            ...
            @JsonProperty("jurisdiction_specific_fields") IdahoFields jurisdictionSpecificFields,
    ...
    public IdahoRegistrationPayload(
            ...
            IdahoFields jurisdictionSpecificFields) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<IdahoRegistrationPayloadAmountFees> amountFees() {
        return (Optional<IdahoRegistrationPayloadAmountFees>) amountFees;
    }
     ...
     */
    @JsonIgnore
    public IdahoFields jurisdictionSpecificFields() {
     ...
     * The date when the registration was created. Format: YYYY-MM-DD.
     */
    public IdahoRegistrationPayload withRegistrationDate(LocalDate registrationDate) {
        Utils.checkNotNull(registrationDate, "registrationDate");
     ...
     * The date when the registration was created. Format: YYYY-MM-DD.
     */
    public IdahoRegistrationPayload withRegistrationDate(JsonNullable<LocalDate> registrationDate) {
        Utils.checkNotNull(registrationDate, "registrationDate");
        this.registrationDate = registrationDate;
        return this;
    }
     ...
     * Email address associated with the registration.
     */
    public IdahoRegistrationPayload withRegistrationEmail(String registrationEmail) {
        Utils.checkNotNull(registrationEmail, "registrationEmail");
     ...
     * Email address associated with the registration.
     */
    public IdahoRegistrationPayload withRegistrationEmail(JsonNullable<String> registrationEmail) {
        Utils.checkNotNull(registrationEmail, "registrationEmail");
        this.registrationEmail = registrationEmail;
        return this;
    }
     ...
     * Timestamp when the registration was requested.
     */
    public IdahoRegistrationPayload withRegistrationRequested(OffsetDateTime registrationRequested) {
        Utils.checkNotNull(registrationRequested, "registrationRequested");
     ...
     * Timestamp when the registration was requested.
     */
    public IdahoRegistrationPayload withRegistrationRequested(JsonNullable<OffsetDateTime> registrationRequested) {
        Utils.checkNotNull(registrationRequested, "registrationRequested");
        this.registrationRequested = registrationRequested;
        return this;
    }
     ...
     * Timestamp when the registration was completed.
     */
    public IdahoRegistrationPayload withRegistrationCompleted(OffsetDateTime registrationCompleted) {
        Utils.checkNotNull(registrationCompleted, "registrationCompleted");
     ...
     * Timestamp when the registration was completed.
     */
    public IdahoRegistrationPayload withRegistrationCompleted(JsonNullable<OffsetDateTime> registrationCompleted) {
        Utils.checkNotNull(registrationCompleted, "registrationCompleted");
        this.registrationCompleted = registrationCompleted;
        return this;
    }
     ...
     * Timestamp when deregistration was requested.
     */
    public IdahoRegistrationPayload withDeregistrationRequested(OffsetDateTime deregistrationRequested) {
        Utils.checkNotNull(deregistrationRequested, "deregistrationRequested");
     ...
     * Timestamp when deregistration was requested.
     */
    public IdahoRegistrationPayload withDeregistrationRequested(JsonNullable<OffsetDateTime> deregistrationRequested) {
        Utils.checkNotNull(deregistrationRequested, "deregistrationRequested");
        this.deregistrationRequested = deregistrationRequested;
        return this;
    }
     ...
     * Timestamp when the deregistration was completed.
     */
    public IdahoRegistrationPayload withDeregistrationCompleted(OffsetDateTime deregistrationCompleted) {
        Utils.checkNotNull(deregistrationCompleted, "deregistrationCompleted");
     ...
     * Timestamp when the deregistration was completed.
     */
    public IdahoRegistrationPayload withDeregistrationCompleted(JsonNullable<OffsetDateTime> deregistrationCompleted) {
        Utils.checkNotNull(deregistrationCompleted, "deregistrationCompleted");
        this.deregistrationCompleted = deregistrationCompleted;
        return this;
    }
     ...
     * Indicates whether the registration was completed automatically.
     */
    public IdahoRegistrationPayload withAutoRegistered(boolean autoRegistered) {
        Utils.checkNotNull(autoRegistered, "autoRegistered");
     ...
     * Indicates whether the registration was completed automatically.
     */
    public IdahoRegistrationPayload withAutoRegistered(JsonNullable<Boolean> autoRegistered) {
        Utils.checkNotNull(autoRegistered, "autoRegistered");
        this.autoRegistered = autoRegistered;
        return this;
    }
     ...
     * If true, do not file for this registration (treated as False by default).
     */
    public IdahoRegistrationPayload withDoNotFile(boolean doNotFile) {
        Utils.checkNotNull(doNotFile, "doNotFile");
     ...
     * If true, do not file for this registration (treated as False by default).
     */
    public IdahoRegistrationPayload withDoNotFile(Optional<Boolean> doNotFile) {
        Utils.checkNotNull(doNotFile, "doNotFile");
        this.doNotFile = doNotFile;
        return this;
    }
     ...
     * The tax registration regime (e.g., STANDARD, SIMPLIFIED).
     */
    public IdahoRegistrationPayload withRegistrationsRegime(RegistrationsRegimeEnum registrationsRegime) {
        Utils.checkNotNull(registrationsRegime, "registrationsRegime");
     ...
     * The tax registration regime (e.g., STANDARD, SIMPLIFIED).
     */
    public IdahoRegistrationPayload withRegistrationsRegime(JsonNullable<? extends RegistrationsRegimeEnum> registrationsRegime) {
        Utils.checkNotNull(registrationsRegime, "registrationsRegime");
        this.registrationsRegime = registrationsRegime;
        return this;
    }

    public IdahoRegistrationPayload withChangeRegimeStatus(ChangeRegimeStatusEnum changeRegimeStatus) {
        Utils.checkNotNull(changeRegimeStatus, "changeRegimeStatus");
        this.changeRegimeStatus = JsonNullable.of(changeRegimeStatus);
        return this;
    }

    public IdahoRegistrationPayload withChangeRegimeStatus(JsonNullable<? extends ChangeRegimeStatusEnum> changeRegimeStatus) {
        Utils.checkNotNull(changeRegimeStatus, "changeRegimeStatus");
        this.changeRegimeStatus = changeRegimeStatus;
        return this;
    }

    public IdahoRegistrationPayload withCountryCode(CountryCodeEnum countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
     ...
     * The state/province code where the registration applies.
     */
    public IdahoRegistrationPayload withStateCode(String stateCode) {
        Utils.checkNotNull(stateCode, "stateCode");
        this.stateCode = stateCode;
        return this;
    }
     ...
     * The name of the state/province.
     */
    public IdahoRegistrationPayload withStateName(String stateName) {
        Utils.checkNotNull(stateName, "stateName");
        this.stateName = stateName;
        return this;
    }

    public IdahoRegistrationPayload withFilingFrequency(FilingFrequencyEnum filingFrequency) {
        Utils.checkNotNull(filingFrequency, "filingFrequency");
        this.filingFrequency = filingFrequency;
        return this;
    }
     ...
     * annual. Null (default) keeps the standard calendar grid.
     */
    public IdahoRegistrationPayload withPeriodEndMonth(long periodEndMonth) {
        Utils.checkNotNull(periodEndMonth, "periodEndMonth");
     ...
     * annual. Null (default) keeps the standard calendar grid.
     */
    public IdahoRegistrationPayload withPeriodEndMonth(JsonNullable<Long> periodEndMonth) {
        Utils.checkNotNull(periodEndMonth, "periodEndMonth");
        this.periodEndMonth = periodEndMonth;
        return this;
    }
     ...
     * Username for accessing tax registration details.
     */
    public IdahoRegistrationPayload withUsername(String username) {
        Utils.checkNotNull(username, "username");
     ...
     * Username for accessing tax registration details.
     */
    public IdahoRegistrationPayload withUsername(JsonNullable<String> username) {
        Utils.checkNotNull(username, "username");
        this.username = username;
        return this;
    }
     ...
     * Additional comments related to the registration.
     */
    public IdahoRegistrationPayload withComment(String comment) {
        Utils.checkNotNull(comment, "comment");
     ...
     * Additional comments related to the registration.
     */
    public IdahoRegistrationPayload withComment(JsonNullable<String> comment) {
        Utils.checkNotNull(comment, "comment");
        this.comment = comment;
        return this;
    }
     ...
     * The date from which filings should be created. should start (YYYY-MM-DD).
     */
    public IdahoRegistrationPayload withCreateFilingsFrom(LocalDate createFilingsFrom) {
        Utils.checkNotNull(createFilingsFrom, "createFilingsFrom");
     ...
     * The date from which filings should be created. should start (YYYY-MM-DD).
     */
    public IdahoRegistrationPayload withCreateFilingsFrom(JsonNullable<LocalDate> createFilingsFrom) {
        Utils.checkNotNull(createFilingsFrom, "createFilingsFrom");
        this.createFilingsFrom = createFilingsFrom;
        return this;
    }
     ...
     * Indicates whether an initial synchronization should be performed.
     */
    public IdahoRegistrationPayload withInitialSync(boolean initialSync) {
        Utils.checkNotNull(initialSync, "initialSync");
     ...
     * Indicates whether an initial synchronization should be performed.
     */
    public IdahoRegistrationPayload withInitialSync(JsonNullable<Boolean> initialSync) {
        Utils.checkNotNull(initialSync, "initialSync");
        this.initialSync = initialSync;
        return this;
    }
     ...
     * The amount of fees associated with the registration.
     */
    public IdahoRegistrationPayload withAmountFees(IdahoRegistrationPayloadAmountFees amountFees) {
        Utils.checkNotNull(amountFees, "amountFees");
     ...
     * The amount of fees associated with the registration.
     */
    public IdahoRegistrationPayload withAmountFees(Optional<? extends IdahoRegistrationPayloadAmountFees> amountFees) {
        Utils.checkNotNull(amountFees, "amountFees");
        this.amountFees = amountFees;
        return this;
    }
     ...
     * Indicates whether a Voluntary Disclosure Agreement (VDA) applies.
     */
    public IdahoRegistrationPayload withVda(boolean vda) {
        Utils.checkNotNull(vda, "vda");
     ...
     * Indicates whether a Voluntary Disclosure Agreement (VDA) applies.
     */
    public IdahoRegistrationPayload withVda(JsonNullable<Boolean> vda) {
        Utils.checkNotNull(vda, "vda");
        this.vda = vda;
        return this;
    }
     ...
     * Whether the registration was imported from another system.
     */
    public IdahoRegistrationPayload withImported(boolean imported) {
        Utils.checkNotNull(imported, "imported");
     ...
     * Whether the registration was imported from another system.
     */
    public IdahoRegistrationPayload withImported(JsonNullable<Boolean> imported) {
        Utils.checkNotNull(imported, "imported");
        this.imported = imported;
        return this;
    }
     ...
     * The sales tax ID associated with the registration.
     */
    public IdahoRegistrationPayload withSalesTaxId(String salesTaxId) {
        Utils.checkNotNull(salesTaxId, "salesTaxId");
     ...
     * The sales tax ID associated with the registration.
     */
    public IdahoRegistrationPayload withSalesTaxId(JsonNullable<String> salesTaxId) {
        Utils.checkNotNull(salesTaxId, "salesTaxId");
        this.salesTaxId = salesTaxId;
        return this;
    }
     ...
     * The Importer of Record (IOR) number associated with the registration.
     */
    public IdahoRegistrationPayload withIorNumber(String iorNumber) {
        Utils.checkNotNull(iorNumber, "iorNumber");
     ...
     * The Importer of Record (IOR) number associated with the registration.
     */
    public IdahoRegistrationPayload withIorNumber(JsonNullable<String> iorNumber) {
        Utils.checkNotNull(iorNumber, "iorNumber");
        this.iorNumber = iorNumber;
        return this;
    }
     ...
     * Indicates whether the registration is an SST Import.
     */
    public IdahoRegistrationPayload withSstImport(boolean sstImport) {
        Utils.checkNotNull(sstImport, "sstImport");
     ...
     * Indicates whether the registration is an SST Import.
     */
    public IdahoRegistrationPayload withSstImport(JsonNullable<Boolean> sstImport) {
        Utils.checkNotNull(sstImport, "sstImport");
        this.sstImport = sstImport;
        return this;
    }
     ...
     * Organization-level tax ID (e.g., VAT number, Canada Business Number).
     */
    public IdahoRegistrationPayload withTaxId(String taxId) {
        Utils.checkNotNull(taxId, "taxId");
     ...
     * Organization-level tax ID (e.g., VAT number, Canada Business Number).
     */
    public IdahoRegistrationPayload withTaxId(JsonNullable<String> taxId) {
        Utils.checkNotNull(taxId, "taxId");
        this.taxId = taxId;
        return this;
    }
     ...
     * The plaintext password for accessing the tax registration account.
     */
    public IdahoRegistrationPayload withPasswordPlainText(String passwordPlainText) {
        Utils.checkNotNull(passwordPlainText, "passwordPlainText");
     ...
     * The plaintext password for accessing the tax registration account.
     */
    public IdahoRegistrationPayload withPasswordPlainText(JsonNullable<String> passwordPlainText) {
        Utils.checkNotNull(passwordPlainText, "passwordPlainText");
        this.passwordPlainText = passwordPlainText;
        return this;
    }
     ...
     * Metadata related to the password.
     */
    public IdahoRegistrationPayload withPasswordMetadataPlainText(String passwordMetadataPlainText) {
        Utils.checkNotNull(passwordMetadataPlainText, "passwordMetadataPlainText");
     ...
     * Metadata related to the password.
     */
    public IdahoRegistrationPayload withPasswordMetadataPlainText(JsonNullable<String> passwordMetadataPlainText) {
        Utils.checkNotNull(passwordMetadataPlainText, "passwordMetadataPlainText");
        this.passwordMetadataPlainText = passwordMetadataPlainText;
        return this;
    }
     ...
     * State-specific fields for Idaho TAP portal registration import.
     */
    public IdahoRegistrationPayload withJurisdictionSpecificFields(IdahoFields jurisdictionSpecificFields) {
        Utils.checkNotNull(jurisdictionSpecificFields, "jurisdictionSpecificFields");
        this.jurisdictionSpecificFields = jurisdictionSpecificFields;
        return this;
    }
     ...
     * Optional client-minted id for this confirm attempt.
     */
    public IdahoRegistrationPayload withRequestId(String requestId) {
        Utils.checkNotNull(requestId, "requestId");
     ...
     * Optional client-minted id for this confirm attempt.
     */
    public IdahoRegistrationPayload withRequestId(JsonNullable<String> requestId) {
        Utils.checkNotNull(requestId, "requestId");
        this.requestId = requestId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        IdahoRegistrationPayload other = (IdahoRegistrationPayload) o;
        return 
    ...
    public String toString() {
        return Utils.toString(IdahoRegistrationPayload.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends IdahoRegistrationPayloadAmountFees> amountFees = Optional.empty();
         ...
         * The amount of fees associated with the registration.
         */
        public Builder amountFees(IdahoRegistrationPayloadAmountFees amountFees) {
            Utils.checkNotNull(amountFees, "amountFees");
            this.amountFees = Optional.ofNullable(amountFees);
            return this;
        }
         ...
         * The amount of fees associated with the registration.
         */
        public Builder amountFees(Optional<? extends IdahoRegistrationPayloadAmountFees> amountFees) {
            Utils.checkNotNull(amountFees, "amountFees");
            this.amountFees = amountFees;
            return this;
        }
         ...
         * State-specific fields for Idaho TAP portal registration import.
         */
        public Builder jurisdictionSpecificFields(IdahoFields jurisdictionSpecificFields) {
            Utils.checkNotNull(jurisdictionSpecificFields, "jurisdictionSpecificFields");
            this.jurisdictionSpecificFields = jurisdictionSpecificFields;
            return this;
        }
        ...
        public IdahoRegistrationPayload build() {
            if (doNotFile == null) {
                doNotFile = _SINGLETON_VALUE_DoNotFile.value();
            }

            return new IdahoRegistrationPayload(
