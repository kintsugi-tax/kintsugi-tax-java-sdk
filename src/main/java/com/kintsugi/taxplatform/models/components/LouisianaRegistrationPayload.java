 ...
 * 
 * <p>Full payload for Louisiana registration import.
 */
public class LouisianaRegistrationPayload {
    /**
    ...
    private Optional<? extends LouisianaRegistrationPayloadAmountFees> amountFees;
    ...
    private LouisianaFields jurisdictionSpecificFields;
    ...
    @JsonCreator
    public LouisianaRegistrationPayload(
            ...
            @JsonProperty("amount_fees") Optional<? extends LouisianaRegistrationPayloadAmountFees> amountFees,
            ...
            @JsonProperty("jurisdiction_specific_fields") LouisianaFields jurisdictionSpecificFields,
    ...
    public LouisianaRegistrationPayload(
            ...
            LouisianaFields jurisdictionSpecificFields) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<LouisianaRegistrationPayloadAmountFees> amountFees() {
        return (Optional<LouisianaRegistrationPayloadAmountFees>) amountFees;
    }
     ...
     */
    @JsonIgnore
    public LouisianaFields jurisdictionSpecificFields() {
     ...
     * The date when the registration was created. Format: YYYY-MM-DD.
     */
    public LouisianaRegistrationPayload withRegistrationDate(LocalDate registrationDate) {
        Utils.checkNotNull(registrationDate, "registrationDate");
     ...
     * The date when the registration was created. Format: YYYY-MM-DD.
     */
    public LouisianaRegistrationPayload withRegistrationDate(JsonNullable<LocalDate> registrationDate) {
        Utils.checkNotNull(registrationDate, "registrationDate");
        this.registrationDate = registrationDate;
        return this;
    }
     ...
     * Email address associated with the registration.
     */
    public LouisianaRegistrationPayload withRegistrationEmail(String registrationEmail) {
        Utils.checkNotNull(registrationEmail, "registrationEmail");
     ...
     * Email address associated with the registration.
     */
    public LouisianaRegistrationPayload withRegistrationEmail(JsonNullable<String> registrationEmail) {
        Utils.checkNotNull(registrationEmail, "registrationEmail");
        this.registrationEmail = registrationEmail;
        return this;
    }
     ...
     * Timestamp when the registration was requested.
     */
    public LouisianaRegistrationPayload withRegistrationRequested(OffsetDateTime registrationRequested) {
        Utils.checkNotNull(registrationRequested, "registrationRequested");
     ...
     * Timestamp when the registration was requested.
     */
    public LouisianaRegistrationPayload withRegistrationRequested(JsonNullable<OffsetDateTime> registrationRequested) {
        Utils.checkNotNull(registrationRequested, "registrationRequested");
        this.registrationRequested = registrationRequested;
        return this;
    }
     ...
     * Timestamp when the registration was completed.
     */
    public LouisianaRegistrationPayload withRegistrationCompleted(OffsetDateTime registrationCompleted) {
        Utils.checkNotNull(registrationCompleted, "registrationCompleted");
     ...
     * Timestamp when the registration was completed.
     */
    public LouisianaRegistrationPayload withRegistrationCompleted(JsonNullable<OffsetDateTime> registrationCompleted) {
        Utils.checkNotNull(registrationCompleted, "registrationCompleted");
        this.registrationCompleted = registrationCompleted;
        return this;
    }
     ...
     * Timestamp when deregistration was requested.
     */
    public LouisianaRegistrationPayload withDeregistrationRequested(OffsetDateTime deregistrationRequested) {
        Utils.checkNotNull(deregistrationRequested, "deregistrationRequested");
     ...
     * Timestamp when deregistration was requested.
     */
    public LouisianaRegistrationPayload withDeregistrationRequested(JsonNullable<OffsetDateTime> deregistrationRequested) {
        Utils.checkNotNull(deregistrationRequested, "deregistrationRequested");
        this.deregistrationRequested = deregistrationRequested;
        return this;
    }
     ...
     * Timestamp when the deregistration was completed.
     */
    public LouisianaRegistrationPayload withDeregistrationCompleted(OffsetDateTime deregistrationCompleted) {
        Utils.checkNotNull(deregistrationCompleted, "deregistrationCompleted");
     ...
     * Timestamp when the deregistration was completed.
     */
    public LouisianaRegistrationPayload withDeregistrationCompleted(JsonNullable<OffsetDateTime> deregistrationCompleted) {
        Utils.checkNotNull(deregistrationCompleted, "deregistrationCompleted");
        this.deregistrationCompleted = deregistrationCompleted;
        return this;
    }
     ...
     * Indicates whether the registration was completed automatically.
     */
    public LouisianaRegistrationPayload withAutoRegistered(boolean autoRegistered) {
        Utils.checkNotNull(autoRegistered, "autoRegistered");
     ...
     * Indicates whether the registration was completed automatically.
     */
    public LouisianaRegistrationPayload withAutoRegistered(JsonNullable<Boolean> autoRegistered) {
        Utils.checkNotNull(autoRegistered, "autoRegistered");
        this.autoRegistered = autoRegistered;
        return this;
    }
     ...
     * If true, do not file for this registration (treated as False by default).
     */
    public LouisianaRegistrationPayload withDoNotFile(boolean doNotFile) {
        Utils.checkNotNull(doNotFile, "doNotFile");
     ...
     * If true, do not file for this registration (treated as False by default).
     */
    public LouisianaRegistrationPayload withDoNotFile(Optional<Boolean> doNotFile) {
        Utils.checkNotNull(doNotFile, "doNotFile");
        this.doNotFile = doNotFile;
        return this;
    }
     ...
     * The tax registration regime (e.g., STANDARD, SIMPLIFIED).
     */
    public LouisianaRegistrationPayload withRegistrationsRegime(RegistrationsRegimeEnum registrationsRegime) {
        Utils.checkNotNull(registrationsRegime, "registrationsRegime");
     ...
     * The tax registration regime (e.g., STANDARD, SIMPLIFIED).
     */
    public LouisianaRegistrationPayload withRegistrationsRegime(JsonNullable<? extends RegistrationsRegimeEnum> registrationsRegime) {
        Utils.checkNotNull(registrationsRegime, "registrationsRegime");
        this.registrationsRegime = registrationsRegime;
        return this;
    }

    public LouisianaRegistrationPayload withChangeRegimeStatus(ChangeRegimeStatusEnum changeRegimeStatus) {
        Utils.checkNotNull(changeRegimeStatus, "changeRegimeStatus");
        this.changeRegimeStatus = JsonNullable.of(changeRegimeStatus);
        return this;
    }

    public LouisianaRegistrationPayload withChangeRegimeStatus(JsonNullable<? extends ChangeRegimeStatusEnum> changeRegimeStatus) {
        Utils.checkNotNull(changeRegimeStatus, "changeRegimeStatus");
        this.changeRegimeStatus = changeRegimeStatus;
        return this;
    }

    public LouisianaRegistrationPayload withCountryCode(CountryCodeEnum countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
     ...
     * The state/province code where the registration applies.
     */
    public LouisianaRegistrationPayload withStateCode(String stateCode) {
        Utils.checkNotNull(stateCode, "stateCode");
        this.stateCode = stateCode;
        return this;
    }
     ...
     * The name of the state/province.
     */
    public LouisianaRegistrationPayload withStateName(String stateName) {
        Utils.checkNotNull(stateName, "stateName");
        this.stateName = stateName;
        return this;
    }

    public LouisianaRegistrationPayload withFilingFrequency(FilingFrequencyEnum filingFrequency) {
        Utils.checkNotNull(filingFrequency, "filingFrequency");
        this.filingFrequency = filingFrequency;
        return this;
    }
     ...
     * annual. Null (default) keeps the standard calendar grid.
     */
    public LouisianaRegistrationPayload withPeriodEndMonth(long periodEndMonth) {
        Utils.checkNotNull(periodEndMonth, "periodEndMonth");
     ...
     * annual. Null (default) keeps the standard calendar grid.
     */
    public LouisianaRegistrationPayload withPeriodEndMonth(JsonNullable<Long> periodEndMonth) {
        Utils.checkNotNull(periodEndMonth, "periodEndMonth");
        this.periodEndMonth = periodEndMonth;
        return this;
    }
     ...
     * Username for accessing tax registration details.
     */
    public LouisianaRegistrationPayload withUsername(String username) {
        Utils.checkNotNull(username, "username");
     ...
     * Username for accessing tax registration details.
     */
    public LouisianaRegistrationPayload withUsername(JsonNullable<String> username) {
        Utils.checkNotNull(username, "username");
        this.username = username;
        return this;
    }
     ...
     * Additional comments related to the registration.
     */
    public LouisianaRegistrationPayload withComment(String comment) {
        Utils.checkNotNull(comment, "comment");
     ...
     * Additional comments related to the registration.
     */
    public LouisianaRegistrationPayload withComment(JsonNullable<String> comment) {
        Utils.checkNotNull(comment, "comment");
        this.comment = comment;
        return this;
    }
     ...
     * The date from which filings should be created. should start (YYYY-MM-DD).
     */
    public LouisianaRegistrationPayload withCreateFilingsFrom(LocalDate createFilingsFrom) {
        Utils.checkNotNull(createFilingsFrom, "createFilingsFrom");
     ...
     * The date from which filings should be created. should start (YYYY-MM-DD).
     */
    public LouisianaRegistrationPayload withCreateFilingsFrom(JsonNullable<LocalDate> createFilingsFrom) {
        Utils.checkNotNull(createFilingsFrom, "createFilingsFrom");
        this.createFilingsFrom = createFilingsFrom;
        return this;
    }
     ...
     * Indicates whether an initial synchronization should be performed.
     */
    public LouisianaRegistrationPayload withInitialSync(boolean initialSync) {
        Utils.checkNotNull(initialSync, "initialSync");
     ...
     * Indicates whether an initial synchronization should be performed.
     */
    public LouisianaRegistrationPayload withInitialSync(JsonNullable<Boolean> initialSync) {
        Utils.checkNotNull(initialSync, "initialSync");
        this.initialSync = initialSync;
        return this;
    }
     ...
     * The amount of fees associated with the registration.
     */
    public LouisianaRegistrationPayload withAmountFees(LouisianaRegistrationPayloadAmountFees amountFees) {
        Utils.checkNotNull(amountFees, "amountFees");
     ...
     * The amount of fees associated with the registration.
     */
    public LouisianaRegistrationPayload withAmountFees(Optional<? extends LouisianaRegistrationPayloadAmountFees> amountFees) {
        Utils.checkNotNull(amountFees, "amountFees");
        this.amountFees = amountFees;
        return this;
    }
     ...
     * Indicates whether a Voluntary Disclosure Agreement (VDA) applies.
     */
    public LouisianaRegistrationPayload withVda(boolean vda) {
        Utils.checkNotNull(vda, "vda");
     ...
     * Indicates whether a Voluntary Disclosure Agreement (VDA) applies.
     */
    public LouisianaRegistrationPayload withVda(JsonNullable<Boolean> vda) {
        Utils.checkNotNull(vda, "vda");
        this.vda = vda;
        return this;
    }
     ...
     * Whether the registration was imported from another system.
     */
    public LouisianaRegistrationPayload withImported(boolean imported) {
        Utils.checkNotNull(imported, "imported");
     ...
     * Whether the registration was imported from another system.
     */
    public LouisianaRegistrationPayload withImported(JsonNullable<Boolean> imported) {
        Utils.checkNotNull(imported, "imported");
        this.imported = imported;
        return this;
    }
     ...
     * The sales tax ID associated with the registration.
     */
    public LouisianaRegistrationPayload withSalesTaxId(String salesTaxId) {
        Utils.checkNotNull(salesTaxId, "salesTaxId");
     ...
     * The sales tax ID associated with the registration.
     */
    public LouisianaRegistrationPayload withSalesTaxId(JsonNullable<String> salesTaxId) {
        Utils.checkNotNull(salesTaxId, "salesTaxId");
        this.salesTaxId = salesTaxId;
        return this;
    }
     ...
     * The Importer of Record (IOR) number associated with the registration.
     */
    public LouisianaRegistrationPayload withIorNumber(String iorNumber) {
        Utils.checkNotNull(iorNumber, "iorNumber");
     ...
     * The Importer of Record (IOR) number associated with the registration.
     */
    public LouisianaRegistrationPayload withIorNumber(JsonNullable<String> iorNumber) {
        Utils.checkNotNull(iorNumber, "iorNumber");
        this.iorNumber = iorNumber;
        return this;
    }
     ...
     * Indicates whether the registration is an SST Import.
     */
    public LouisianaRegistrationPayload withSstImport(boolean sstImport) {
        Utils.checkNotNull(sstImport, "sstImport");
     ...
     * Indicates whether the registration is an SST Import.
     */
    public LouisianaRegistrationPayload withSstImport(JsonNullable<Boolean> sstImport) {
        Utils.checkNotNull(sstImport, "sstImport");
        this.sstImport = sstImport;
        return this;
    }
     ...
     * Organization-level tax ID (e.g., VAT number, Canada Business Number).
     */
    public LouisianaRegistrationPayload withTaxId(String taxId) {
        Utils.checkNotNull(taxId, "taxId");
     ...
     * Organization-level tax ID (e.g., VAT number, Canada Business Number).
     */
    public LouisianaRegistrationPayload withTaxId(JsonNullable<String> taxId) {
        Utils.checkNotNull(taxId, "taxId");
        this.taxId = taxId;
        return this;
    }
     ...
     * The plaintext password for accessing the tax registration account.
     */
    public LouisianaRegistrationPayload withPasswordPlainText(String passwordPlainText) {
        Utils.checkNotNull(passwordPlainText, "passwordPlainText");
     ...
     * The plaintext password for accessing the tax registration account.
     */
    public LouisianaRegistrationPayload withPasswordPlainText(JsonNullable<String> passwordPlainText) {
        Utils.checkNotNull(passwordPlainText, "passwordPlainText");
        this.passwordPlainText = passwordPlainText;
        return this;
    }
     ...
     * Metadata related to the password.
     */
    public LouisianaRegistrationPayload withPasswordMetadataPlainText(String passwordMetadataPlainText) {
        Utils.checkNotNull(passwordMetadataPlainText, "passwordMetadataPlainText");
     ...
     * Metadata related to the password.
     */
    public LouisianaRegistrationPayload withPasswordMetadataPlainText(JsonNullable<String> passwordMetadataPlainText) {
        Utils.checkNotNull(passwordMetadataPlainText, "passwordMetadataPlainText");
        this.passwordMetadataPlainText = passwordMetadataPlainText;
        return this;
    }
     ...
     * and Standard licenses file in Parish E-File.
     */
    public LouisianaRegistrationPayload withJurisdictionSpecificFields(LouisianaFields jurisdictionSpecificFields) {
        Utils.checkNotNull(jurisdictionSpecificFields, "jurisdictionSpecificFields");
        this.jurisdictionSpecificFields = jurisdictionSpecificFields;
        return this;
    }
     ...
     * Optional client-minted id for this confirm attempt.
     */
    public LouisianaRegistrationPayload withRequestId(String requestId) {
        Utils.checkNotNull(requestId, "requestId");
     ...
     * Optional client-minted id for this confirm attempt.
     */
    public LouisianaRegistrationPayload withRequestId(JsonNullable<String> requestId) {
        Utils.checkNotNull(requestId, "requestId");
        this.requestId = requestId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LouisianaRegistrationPayload other = (LouisianaRegistrationPayload) o;
        return 
    ...
    public String toString() {
        return Utils.toString(LouisianaRegistrationPayload.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends LouisianaRegistrationPayloadAmountFees> amountFees = Optional.empty();
         ...
         * The amount of fees associated with the registration.
         */
        public Builder amountFees(LouisianaRegistrationPayloadAmountFees amountFees) {
            Utils.checkNotNull(amountFees, "amountFees");
            this.amountFees = Optional.ofNullable(amountFees);
            return this;
        }
         ...
         * The amount of fees associated with the registration.
         */
        public Builder amountFees(Optional<? extends LouisianaRegistrationPayloadAmountFees> amountFees) {
            Utils.checkNotNull(amountFees, "amountFees");
            this.amountFees = amountFees;
            return this;
        }
         ...
         * and Standard licenses file in Parish E-File.
         */
        public Builder jurisdictionSpecificFields(LouisianaFields jurisdictionSpecificFields) {
            Utils.checkNotNull(jurisdictionSpecificFields, "jurisdictionSpecificFields");
            this.jurisdictionSpecificFields = jurisdictionSpecificFields;
            return this;
        }
        ...
        public LouisianaRegistrationPayload build() {
            if (doNotFile == null) {
                doNotFile = _SINGLETON_VALUE_DoNotFile.value();
            }

            return new LouisianaRegistrationPayload(
