 ...
 * 
 * <p>Full payload for Oklahoma registration import.
 */
public class OklahomaRegistrationPayload {
    /**
    ...
    private Optional<? extends OklahomaRegistrationPayloadAmountFees> amountFees;
    ...
    private OklahomaFields jurisdictionSpecificFields;
    ...
    @JsonCreator
    public OklahomaRegistrationPayload(
            ...
            @JsonProperty("amount_fees") Optional<? extends OklahomaRegistrationPayloadAmountFees> amountFees,
            ...
            @JsonProperty("jurisdiction_specific_fields") OklahomaFields jurisdictionSpecificFields,
    ...
    public OklahomaRegistrationPayload(
            ...
            OklahomaFields jurisdictionSpecificFields) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public Optional<OklahomaRegistrationPayloadAmountFees> amountFees() {
        return (Optional<OklahomaRegistrationPayloadAmountFees>) amountFees;
    }
     ...
     */
    @JsonIgnore
    public OklahomaFields jurisdictionSpecificFields() {
     ...
     * The date when the registration was created. Format: YYYY-MM-DD.
     */
    public OklahomaRegistrationPayload withRegistrationDate(LocalDate registrationDate) {
        Utils.checkNotNull(registrationDate, "registrationDate");
     ...
     * The date when the registration was created. Format: YYYY-MM-DD.
     */
    public OklahomaRegistrationPayload withRegistrationDate(JsonNullable<LocalDate> registrationDate) {
        Utils.checkNotNull(registrationDate, "registrationDate");
        this.registrationDate = registrationDate;
        return this;
    }
     ...
     * Email address associated with the registration.
     */
    public OklahomaRegistrationPayload withRegistrationEmail(String registrationEmail) {
        Utils.checkNotNull(registrationEmail, "registrationEmail");
     ...
     * Email address associated with the registration.
     */
    public OklahomaRegistrationPayload withRegistrationEmail(JsonNullable<String> registrationEmail) {
        Utils.checkNotNull(registrationEmail, "registrationEmail");
        this.registrationEmail = registrationEmail;
        return this;
    }
     ...
     * Timestamp when the registration was requested.
     */
    public OklahomaRegistrationPayload withRegistrationRequested(OffsetDateTime registrationRequested) {
        Utils.checkNotNull(registrationRequested, "registrationRequested");
     ...
     * Timestamp when the registration was requested.
     */
    public OklahomaRegistrationPayload withRegistrationRequested(JsonNullable<OffsetDateTime> registrationRequested) {
        Utils.checkNotNull(registrationRequested, "registrationRequested");
        this.registrationRequested = registrationRequested;
        return this;
    }
     ...
     * Timestamp when the registration was completed.
     */
    public OklahomaRegistrationPayload withRegistrationCompleted(OffsetDateTime registrationCompleted) {
        Utils.checkNotNull(registrationCompleted, "registrationCompleted");
     ...
     * Timestamp when the registration was completed.
     */
    public OklahomaRegistrationPayload withRegistrationCompleted(JsonNullable<OffsetDateTime> registrationCompleted) {
        Utils.checkNotNull(registrationCompleted, "registrationCompleted");
        this.registrationCompleted = registrationCompleted;
        return this;
    }
     ...
     * Timestamp when deregistration was requested.
     */
    public OklahomaRegistrationPayload withDeregistrationRequested(OffsetDateTime deregistrationRequested) {
        Utils.checkNotNull(deregistrationRequested, "deregistrationRequested");
     ...
     * Timestamp when deregistration was requested.
     */
    public OklahomaRegistrationPayload withDeregistrationRequested(JsonNullable<OffsetDateTime> deregistrationRequested) {
        Utils.checkNotNull(deregistrationRequested, "deregistrationRequested");
        this.deregistrationRequested = deregistrationRequested;
        return this;
    }
     ...
     * Timestamp when the deregistration was completed.
     */
    public OklahomaRegistrationPayload withDeregistrationCompleted(OffsetDateTime deregistrationCompleted) {
        Utils.checkNotNull(deregistrationCompleted, "deregistrationCompleted");
     ...
     * Timestamp when the deregistration was completed.
     */
    public OklahomaRegistrationPayload withDeregistrationCompleted(JsonNullable<OffsetDateTime> deregistrationCompleted) {
        Utils.checkNotNull(deregistrationCompleted, "deregistrationCompleted");
        this.deregistrationCompleted = deregistrationCompleted;
        return this;
    }
     ...
     * Indicates whether the registration was completed automatically.
     */
    public OklahomaRegistrationPayload withAutoRegistered(boolean autoRegistered) {
        Utils.checkNotNull(autoRegistered, "autoRegistered");
     ...
     * Indicates whether the registration was completed automatically.
     */
    public OklahomaRegistrationPayload withAutoRegistered(JsonNullable<Boolean> autoRegistered) {
        Utils.checkNotNull(autoRegistered, "autoRegistered");
        this.autoRegistered = autoRegistered;
        return this;
    }
     ...
     * If true, do not file for this registration (treated as False by default).
     */
    public OklahomaRegistrationPayload withDoNotFile(boolean doNotFile) {
        Utils.checkNotNull(doNotFile, "doNotFile");
     ...
     * If true, do not file for this registration (treated as False by default).
     */
    public OklahomaRegistrationPayload withDoNotFile(Optional<Boolean> doNotFile) {
        Utils.checkNotNull(doNotFile, "doNotFile");
        this.doNotFile = doNotFile;
        return this;
    }
     ...
     * The tax registration regime (e.g., STANDARD, SIMPLIFIED).
     */
    public OklahomaRegistrationPayload withRegistrationsRegime(RegistrationsRegimeEnum registrationsRegime) {
        Utils.checkNotNull(registrationsRegime, "registrationsRegime");
     ...
     * The tax registration regime (e.g., STANDARD, SIMPLIFIED).
     */
    public OklahomaRegistrationPayload withRegistrationsRegime(JsonNullable<? extends RegistrationsRegimeEnum> registrationsRegime) {
        Utils.checkNotNull(registrationsRegime, "registrationsRegime");
        this.registrationsRegime = registrationsRegime;
        return this;
    }

    public OklahomaRegistrationPayload withChangeRegimeStatus(ChangeRegimeStatusEnum changeRegimeStatus) {
        Utils.checkNotNull(changeRegimeStatus, "changeRegimeStatus");
        this.changeRegimeStatus = JsonNullable.of(changeRegimeStatus);
        return this;
    }

    public OklahomaRegistrationPayload withChangeRegimeStatus(JsonNullable<? extends ChangeRegimeStatusEnum> changeRegimeStatus) {
        Utils.checkNotNull(changeRegimeStatus, "changeRegimeStatus");
        this.changeRegimeStatus = changeRegimeStatus;
        return this;
    }

    public OklahomaRegistrationPayload withCountryCode(CountryCodeEnum countryCode) {
        Utils.checkNotNull(countryCode, "countryCode");
        this.countryCode = countryCode;
        return this;
    }
     ...
     * The state/province code where the registration applies.
     */
    public OklahomaRegistrationPayload withStateCode(String stateCode) {
        Utils.checkNotNull(stateCode, "stateCode");
        this.stateCode = stateCode;
        return this;
    }
     ...
     * The name of the state/province.
     */
    public OklahomaRegistrationPayload withStateName(String stateName) {
        Utils.checkNotNull(stateName, "stateName");
        this.stateName = stateName;
        return this;
    }

    public OklahomaRegistrationPayload withFilingFrequency(FilingFrequencyEnum filingFrequency) {
        Utils.checkNotNull(filingFrequency, "filingFrequency");
        this.filingFrequency = filingFrequency;
        return this;
    }
     ...
     * annual. Null (default) keeps the standard calendar grid.
     */
    public OklahomaRegistrationPayload withPeriodEndMonth(long periodEndMonth) {
        Utils.checkNotNull(periodEndMonth, "periodEndMonth");
     ...
     * annual. Null (default) keeps the standard calendar grid.
     */
    public OklahomaRegistrationPayload withPeriodEndMonth(JsonNullable<Long> periodEndMonth) {
        Utils.checkNotNull(periodEndMonth, "periodEndMonth");
        this.periodEndMonth = periodEndMonth;
        return this;
    }
     ...
     * Username for accessing tax registration details.
     */
    public OklahomaRegistrationPayload withUsername(String username) {
        Utils.checkNotNull(username, "username");
     ...
     * Username for accessing tax registration details.
     */
    public OklahomaRegistrationPayload withUsername(JsonNullable<String> username) {
        Utils.checkNotNull(username, "username");
        this.username = username;
        return this;
    }
     ...
     * Additional comments related to the registration.
     */
    public OklahomaRegistrationPayload withComment(String comment) {
        Utils.checkNotNull(comment, "comment");
     ...
     * Additional comments related to the registration.
     */
    public OklahomaRegistrationPayload withComment(JsonNullable<String> comment) {
        Utils.checkNotNull(comment, "comment");
        this.comment = comment;
        return this;
    }
     ...
     * The date from which filings should be created. should start (YYYY-MM-DD).
     */
    public OklahomaRegistrationPayload withCreateFilingsFrom(LocalDate createFilingsFrom) {
        Utils.checkNotNull(createFilingsFrom, "createFilingsFrom");
     ...
     * The date from which filings should be created. should start (YYYY-MM-DD).
     */
    public OklahomaRegistrationPayload withCreateFilingsFrom(JsonNullable<LocalDate> createFilingsFrom) {
        Utils.checkNotNull(createFilingsFrom, "createFilingsFrom");
        this.createFilingsFrom = createFilingsFrom;
        return this;
    }
     ...
     * Indicates whether an initial synchronization should be performed.
     */
    public OklahomaRegistrationPayload withInitialSync(boolean initialSync) {
        Utils.checkNotNull(initialSync, "initialSync");
     ...
     * Indicates whether an initial synchronization should be performed.
     */
    public OklahomaRegistrationPayload withInitialSync(JsonNullable<Boolean> initialSync) {
        Utils.checkNotNull(initialSync, "initialSync");
        this.initialSync = initialSync;
        return this;
    }
     ...
     * The amount of fees associated with the registration.
     */
    public OklahomaRegistrationPayload withAmountFees(OklahomaRegistrationPayloadAmountFees amountFees) {
        Utils.checkNotNull(amountFees, "amountFees");
     ...
     * The amount of fees associated with the registration.
     */
    public OklahomaRegistrationPayload withAmountFees(Optional<? extends OklahomaRegistrationPayloadAmountFees> amountFees) {
        Utils.checkNotNull(amountFees, "amountFees");
        this.amountFees = amountFees;
        return this;
    }
     ...
     * Indicates whether a Voluntary Disclosure Agreement (VDA) applies.
     */
    public OklahomaRegistrationPayload withVda(boolean vda) {
        Utils.checkNotNull(vda, "vda");
     ...
     * Indicates whether a Voluntary Disclosure Agreement (VDA) applies.
     */
    public OklahomaRegistrationPayload withVda(JsonNullable<Boolean> vda) {
        Utils.checkNotNull(vda, "vda");
        this.vda = vda;
        return this;
    }
     ...
     * Whether the registration was imported from another system.
     */
    public OklahomaRegistrationPayload withImported(boolean imported) {
        Utils.checkNotNull(imported, "imported");
     ...
     * Whether the registration was imported from another system.
     */
    public OklahomaRegistrationPayload withImported(JsonNullable<Boolean> imported) {
        Utils.checkNotNull(imported, "imported");
        this.imported = imported;
        return this;
    }
     ...
     * The sales tax ID associated with the registration.
     */
    public OklahomaRegistrationPayload withSalesTaxId(String salesTaxId) {
        Utils.checkNotNull(salesTaxId, "salesTaxId");
     ...
     * The sales tax ID associated with the registration.
     */
    public OklahomaRegistrationPayload withSalesTaxId(JsonNullable<String> salesTaxId) {
        Utils.checkNotNull(salesTaxId, "salesTaxId");
        this.salesTaxId = salesTaxId;
        return this;
    }
     ...
     * The Importer of Record (IOR) number associated with the registration.
     */
    public OklahomaRegistrationPayload withIorNumber(String iorNumber) {
        Utils.checkNotNull(iorNumber, "iorNumber");
     ...
     * The Importer of Record (IOR) number associated with the registration.
     */
    public OklahomaRegistrationPayload withIorNumber(JsonNullable<String> iorNumber) {
        Utils.checkNotNull(iorNumber, "iorNumber");
        this.iorNumber = iorNumber;
        return this;
    }
     ...
     * Indicates whether the registration is an SST Import.
     */
    public OklahomaRegistrationPayload withSstImport(boolean sstImport) {
        Utils.checkNotNull(sstImport, "sstImport");
     ...
     * Indicates whether the registration is an SST Import.
     */
    public OklahomaRegistrationPayload withSstImport(JsonNullable<Boolean> sstImport) {
        Utils.checkNotNull(sstImport, "sstImport");
        this.sstImport = sstImport;
        return this;
    }
     ...
     * Organization-level tax ID (e.g., VAT number, Canada Business Number).
     */
    public OklahomaRegistrationPayload withTaxId(String taxId) {
        Utils.checkNotNull(taxId, "taxId");
     ...
     * Organization-level tax ID (e.g., VAT number, Canada Business Number).
     */
    public OklahomaRegistrationPayload withTaxId(JsonNullable<String> taxId) {
        Utils.checkNotNull(taxId, "taxId");
        this.taxId = taxId;
        return this;
    }
     ...
     * The plaintext password for accessing the tax registration account.
     */
    public OklahomaRegistrationPayload withPasswordPlainText(String passwordPlainText) {
        Utils.checkNotNull(passwordPlainText, "passwordPlainText");
     ...
     * The plaintext password for accessing the tax registration account.
     */
    public OklahomaRegistrationPayload withPasswordPlainText(JsonNullable<String> passwordPlainText) {
        Utils.checkNotNull(passwordPlainText, "passwordPlainText");
        this.passwordPlainText = passwordPlainText;
        return this;
    }
     ...
     * Metadata related to the password.
     */
    public OklahomaRegistrationPayload withPasswordMetadataPlainText(String passwordMetadataPlainText) {
        Utils.checkNotNull(passwordMetadataPlainText, "passwordMetadataPlainText");
     ...
     * Metadata related to the password.
     */
    public OklahomaRegistrationPayload withPasswordMetadataPlainText(JsonNullable<String> passwordMetadataPlainText) {
        Utils.checkNotNull(passwordMetadataPlainText, "passwordMetadataPlainText");
        this.passwordMetadataPlainText = passwordMetadataPlainText;
        return this;
    }
     ...
     * State-specific fields for Oklahoma OkTAP portal registration import.
     */
    public OklahomaRegistrationPayload withJurisdictionSpecificFields(OklahomaFields jurisdictionSpecificFields) {
        Utils.checkNotNull(jurisdictionSpecificFields, "jurisdictionSpecificFields");
        this.jurisdictionSpecificFields = jurisdictionSpecificFields;
        return this;
    }
     ...
     * Optional client-minted id for this confirm attempt.
     */
    public OklahomaRegistrationPayload withRequestId(String requestId) {
        Utils.checkNotNull(requestId, "requestId");
     ...
     * Optional client-minted id for this confirm attempt.
     */
    public OklahomaRegistrationPayload withRequestId(JsonNullable<String> requestId) {
        Utils.checkNotNull(requestId, "requestId");
        this.requestId = requestId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OklahomaRegistrationPayload other = (OklahomaRegistrationPayload) o;
        return 
    ...
    public String toString() {
        return Utils.toString(OklahomaRegistrationPayload.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends OklahomaRegistrationPayloadAmountFees> amountFees = Optional.empty();
         ...
         * The amount of fees associated with the registration.
         */
        public Builder amountFees(OklahomaRegistrationPayloadAmountFees amountFees) {
            Utils.checkNotNull(amountFees, "amountFees");
            this.amountFees = Optional.ofNullable(amountFees);
            return this;
        }
         ...
         * The amount of fees associated with the registration.
         */
        public Builder amountFees(Optional<? extends OklahomaRegistrationPayloadAmountFees> amountFees) {
            Utils.checkNotNull(amountFees, "amountFees");
            this.amountFees = amountFees;
            return this;
        }
         ...
         * State-specific fields for Oklahoma OkTAP portal registration import.
         */
        public Builder jurisdictionSpecificFields(OklahomaFields jurisdictionSpecificFields) {
            Utils.checkNotNull(jurisdictionSpecificFields, "jurisdictionSpecificFields");
            this.jurisdictionSpecificFields = jurisdictionSpecificFields;
            return this;
        }
        ...
        public OklahomaRegistrationPayload build() {
            if (doNotFile == null) {
                doNotFile = _SINGLETON_VALUE_DoNotFile.value();
            }

            return new OklahomaRegistrationPayload(
