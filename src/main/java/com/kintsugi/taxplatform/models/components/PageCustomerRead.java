...
public class PageCustomerRead {
    ...
    @JsonIgnore
    public List<CustomerRead> items() {
        return items;
    }
    ...
    public PageCustomerRead withItems(List<CustomerRead> items) {
        Utils.checkNotNull(items, "items");
        this.items = items;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PageCustomerRead other = (PageCustomerRead) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PageCustomerRead.class,
                "items", items,
                "total", total,
                "page", page,
                "size", size,
    ...
    public final static class Builder {
        ...
        public Builder items(List<CustomerRead> items) {
            Utils.checkNotNull(items, "items");
            this.items = items;
            return this;
        }
        ...
        public PageCustomerRead build() {

            return new PageCustomerRead(
                items, total, page,
                size, pages);
        }
