...
public enum PhysicalNexusCategory {
    ...
    PhysicalNexusCategory(String value) {
        this.value = value;
    }
    ...
    public static Optional<PhysicalNexusCategory> fromValue(String value) {
        for (PhysicalNexusCategory o: PhysicalNexusCategory.values()) {
