...
public class ProductCategoryRead {
     ...
     * (e.g., PHYSICAL, SERVICE, DIGITAL, MISCELLANEOUS)
     */
    public ProductCategoryRead withName(String name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * List of subcategories associated with the product category
     */
    public ProductCategoryRead withSubcategories(List<ProductSubCategory> subcategories) {
        Utils.checkNotNull(subcategories, "subcategories");
        this.subcategories = subcategories;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ProductCategoryRead other = (ProductCategoryRead) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ProductCategoryRead.class,
                "name", name,
    ...
    public final static class Builder {
        ...
        public ProductCategoryRead build() {

            return new ProductCategoryRead(
                name, subcategories);
        }
