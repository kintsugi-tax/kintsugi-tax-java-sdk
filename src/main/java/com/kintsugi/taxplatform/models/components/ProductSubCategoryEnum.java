...
public enum ProductSubCategoryEnum {
    ...
    ProductSubCategoryEnum(String value) {
        this.value = value;
    }
    ...
    public static Optional<ProductSubCategoryEnum> fromValue(String value) {
        for (ProductSubCategoryEnum o: ProductSubCategoryEnum.values()) {
