...
public class TransactionAddressInput {
    /**
    ...
    @JsonCreator
    public TransactionAddressInput(
     ...
     * Phone number associated with the address.
     */
    public TransactionAddressInput withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * Phone number associated with the address.
     */
    public TransactionAddressInput withPhone(JsonNullable<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * Primary street address.
     */
    public TransactionAddressInput withStreet1(String street1) {
        Utils.checkNotNull(street1, "street1");
     ...
     * Primary street address.
     */
    public TransactionAddressInput withStreet1(JsonNullable<String> street1) {
        Utils.checkNotNull(street1, "street1");
        this.street1 = street1;
        return this;
    }
     ...
     * Additional street address details, such as an apartment or suite number.
     */
    public TransactionAddressInput withStreet2(String street2) {
        Utils.checkNotNull(street2, "street2");
     ...
     * Additional street address details, such as an apartment or suite number.
     */
    public TransactionAddressInput withStreet2(JsonNullable<String> street2) {
        Utils.checkNotNull(street2, "street2");
        this.street2 = street2;
        return this;
    }
     ...
     * City where the customer resides.
     */
    public TransactionAddressInput withCity(String city) {
        Utils.checkNotNull(city, "city");
     ...
     * City where the customer resides.
     */
    public TransactionAddressInput withCity(JsonNullable<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * County or district of the customer.
     */
    public TransactionAddressInput withCounty(String county) {
        Utils.checkNotNull(county, "county");
     ...
     * County or district of the customer.
     */
    public TransactionAddressInput withCounty(JsonNullable<String> county) {
        Utils.checkNotNull(county, "county");
        this.county = county;
        return this;
    }
     ...
     * State or province of the customer.
     */
    public TransactionAddressInput withState(String state) {
        Utils.checkNotNull(state, "state");
     ...
     * State or province of the customer.
     */
    public TransactionAddressInput withState(JsonNullable<String> state) {
        Utils.checkNotNull(state, "state");
        this.state = state;
        return this;
    }
     ...
     * ZIP or Postal code of the customer.
     */
    public TransactionAddressInput withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
     ...
     * ZIP or Postal code of the customer.
     */
    public TransactionAddressInput withPostalCode(JsonNullable<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * Country code in ISO 3166-1 alpha-2 format
     */
    public TransactionAddressInput withCountry(CountryCodeEnum country) {
        Utils.checkNotNull(country, "country");
     ...
     * Country code in ISO 3166-1 alpha-2 format
     */
    public TransactionAddressInput withCountry(JsonNullable<? extends CountryCodeEnum> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * Complete address string of the customer, which can be used as an alternative to individual fields.
     */
    public TransactionAddressInput withFullAddress(String fullAddress) {
        Utils.checkNotNull(fullAddress, "fullAddress");
     ...
     * Complete address string of the customer, which can be used as an alternative to individual fields.
     */
    public TransactionAddressInput withFullAddress(JsonNullable<String> fullAddress) {
        Utils.checkNotNull(fullAddress, "fullAddress");
        this.fullAddress = fullAddress;
        return this;
    }

    public TransactionAddressInput withType(AddressType type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * Optional additional enriched data for the address.
     */
    public TransactionAddressInput withEnrichedFields(String enrichedFields) {
        Utils.checkNotNull(enrichedFields, "enrichedFields");
     ...
     * Optional additional enriched data for the address.
     */
    public TransactionAddressInput withEnrichedFields(JsonNullable<String> enrichedFields) {
        Utils.checkNotNull(enrichedFields, "enrichedFields");
        this.enrichedFields = enrichedFields;
        return this;
    }
     ...
     * If true, city-level tax rates are not applied for this address.
     */
    public TransactionAddressInput withIsUnincorporated(boolean isUnincorporated) {
        Utils.checkNotNull(isUnincorporated, "isUnincorporated");
     ...
     * If true, city-level tax rates are not applied for this address.
     */
    public TransactionAddressInput withIsUnincorporated(Optional<Boolean> isUnincorporated) {
        Utils.checkNotNull(isUnincorporated, "isUnincorporated");
        this.isUnincorporated = isUnincorporated;
        return this;
    }

    public TransactionAddressInput withStatus(AddressStatus status) {
        Utils.checkNotNull(status, "status");
    ...
    public TransactionAddressInput withStatus(Optional<? extends AddressStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransactionAddressInput other = (TransactionAddressInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(TransactionAddressInput.class,
                "phone", phone,
                "street1", street1,
                "street2", street2,
                "city", city,
