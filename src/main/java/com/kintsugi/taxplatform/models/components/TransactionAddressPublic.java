 ...
 * 
 * <p>API-facing transaction address without internal enrichment fields.
 */
public class TransactionAddressPublic {
     ...
     * If true, city-level tax rates are not applied for this address.
     */
    public TransactionAddressPublic withIsUnincorporated(boolean isUnincorporated) {
        Utils.checkNotNull(isUnincorporated, "isUnincorporated");
     ...
     * If true, city-level tax rates are not applied for this address.
     */
    public TransactionAddressPublic withIsUnincorporated(Optional<Boolean> isUnincorporated) {
        Utils.checkNotNull(isUnincorporated, "isUnincorporated");
        this.isUnincorporated = isUnincorporated;
        return this;
    }
