...
public class BackendSrcTransactionsResponsesValidationErrorResponse extends SDKError {
    ...
    /**
    * Parse a response into an instance of BackendSrcTransactionsResponsesValidationErrorResponse. If deserialization of the response body fails,
    ...
    */
    ...
    /**
    * Parse a response into an instance of BackendSrcTransactionsResponsesValidationErrorResponse asynchronously. If deserialization of the response body fails,
    * the resulting BackendSrcTransactionsResponsesValidationErrorResponse instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<BackendSrcTransactionsResponsesValidationErrorResponse> fromAsync(HttpResponse<Blob> response) {
    ...
    @Deprecated
    public Optional<List<BackendSrcTransactionsResponsesValidationErrorItem>> detail() {
    ...
    public static class Data {
        ...
        public Data withDetail(List<BackendSrcTransactionsResponsesValidationErrorItem> detail) {
            Utils.checkNotNull(detail, "detail");
            this.detail = detail;
            return this;
        }
