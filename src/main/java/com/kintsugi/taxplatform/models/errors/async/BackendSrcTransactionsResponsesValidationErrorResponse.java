...
public class BackendSrcTransactionsResponsesValidationErrorResponse extends RuntimeException {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public BackendSrcTransactionsResponsesValidationErrorResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public BackendSrcTransactionsResponsesValidationErrorResponse withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
