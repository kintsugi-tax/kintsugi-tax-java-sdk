...
public class CreateCustomerV1CustomersPostSecurity implements HasSecurity {
    ...
    @JsonCreator
    public CreateCustomerV1CustomersPostSecurity(
    ...
    public CreateCustomerV1CustomersPostSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public CreateCustomerV1CustomersPostSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public CreateCustomerV1CustomersPostSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public CreateCustomerV1CustomersPostSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCustomerV1CustomersPostSecurity other = (CreateCustomerV1CustomersPostSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateCustomerV1CustomersPostSecurity.class,
    ...
    public final static class Builder {
        ...
        public CreateCustomerV1CustomersPostSecurity build() {

            return new CreateCustomerV1CustomersPostSecurity(
                apiKeyHeader, httpBearer);
        }
