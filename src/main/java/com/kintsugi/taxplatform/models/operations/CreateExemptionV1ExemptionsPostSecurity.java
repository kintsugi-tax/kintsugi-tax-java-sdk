...
public class CreateExemptionV1ExemptionsPostSecurity implements HasSecurity {
    ...
    @JsonCreator
    public CreateExemptionV1ExemptionsPostSecurity(
    ...
    public CreateExemptionV1ExemptionsPostSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public CreateExemptionV1ExemptionsPostSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public CreateExemptionV1ExemptionsPostSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public CreateExemptionV1ExemptionsPostSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateExemptionV1ExemptionsPostSecurity other = (CreateExemptionV1ExemptionsPostSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateExemptionV1ExemptionsPostSecurity.class,
    ...
    public final static class Builder {
        ...
        public CreateExemptionV1ExemptionsPostSecurity build() {

            return new CreateExemptionV1ExemptionsPostSecurity(
                apiKeyHeader, httpBearer);
        }
