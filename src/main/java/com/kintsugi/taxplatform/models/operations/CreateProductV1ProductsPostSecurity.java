...
public class CreateProductV1ProductsPostSecurity implements HasSecurity {
    ...
    @JsonCreator
    public CreateProductV1ProductsPostSecurity(
    ...
    public CreateProductV1ProductsPostSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public CreateProductV1ProductsPostSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public CreateProductV1ProductsPostSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public CreateProductV1ProductsPostSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateProductV1ProductsPostSecurity other = (CreateProductV1ProductsPostSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateProductV1ProductsPostSecurity.class,
    ...
    public final static class Builder {
        ...
        public CreateProductV1ProductsPostSecurity build() {

            return new CreateProductV1ProductsPostSecurity(
                apiKeyHeader, httpBearer);
        }
