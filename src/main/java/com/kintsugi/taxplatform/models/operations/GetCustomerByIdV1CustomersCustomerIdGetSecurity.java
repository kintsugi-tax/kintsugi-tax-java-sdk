...
public class GetCustomerByIdV1CustomersCustomerIdGetSecurity implements HasSecurity {
    ...
    @JsonCreator
    public GetCustomerByIdV1CustomersCustomerIdGetSecurity(
    ...
    public GetCustomerByIdV1CustomersCustomerIdGetSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public GetCustomerByIdV1CustomersCustomerIdGetSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public GetCustomerByIdV1CustomersCustomerIdGetSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public GetCustomerByIdV1CustomersCustomerIdGetSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCustomerByIdV1CustomersCustomerIdGetSecurity other = (GetCustomerByIdV1CustomersCustomerIdGetSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCustomerByIdV1CustomersCustomerIdGetSecurity.class,
    ...
    public final static class Builder {
        ...
        public GetCustomerByIdV1CustomersCustomerIdGetSecurity build() {

            return new GetCustomerByIdV1CustomersCustomerIdGetSecurity(
                apiKeyHeader, httpBearer);
        }
