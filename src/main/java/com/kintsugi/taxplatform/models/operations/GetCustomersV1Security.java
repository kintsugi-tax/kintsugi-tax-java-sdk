...
public class GetCustomersV1Security implements HasSecurity {
    ...
    public GetCustomersV1Security withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public GetCustomersV1Security withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public GetCustomersV1Security withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public GetCustomersV1Security withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetCustomersV1Security other = (GetCustomersV1Security) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetCustomersV1Security.class,
    ...
    public final static class Builder {
        ...
        public GetCustomersV1Security build() {

            return new GetCustomersV1Security(
                apiKeyHeader, httpBearer);
        }
