...
public class GetExemptionByIdV1ExemptionsExemptionIdGetSecurity implements HasSecurity {
    ...
    @JsonCreator
    public GetExemptionByIdV1ExemptionsExemptionIdGetSecurity(
    ...
    public GetExemptionByIdV1ExemptionsExemptionIdGetSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public GetExemptionByIdV1ExemptionsExemptionIdGetSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public GetExemptionByIdV1ExemptionsExemptionIdGetSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public GetExemptionByIdV1ExemptionsExemptionIdGetSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetExemptionByIdV1ExemptionsExemptionIdGetSecurity other = (GetExemptionByIdV1ExemptionsExemptionIdGetSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetExemptionByIdV1ExemptionsExemptionIdGetSecurity.class,
    ...
    public final static class Builder {
        ...
        public GetExemptionByIdV1ExemptionsExemptionIdGetSecurity build() {

            return new GetExemptionByIdV1ExemptionsExemptionIdGetSecurity(
                apiKeyHeader, httpBearer);
        }
