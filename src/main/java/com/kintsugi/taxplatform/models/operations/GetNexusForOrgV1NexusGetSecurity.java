...
public class GetNexusForOrgV1NexusGetSecurity implements HasSecurity {
    ...
    @JsonCreator
    public GetNexusForOrgV1NexusGetSecurity(
    ...
    public GetNexusForOrgV1NexusGetSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public GetNexusForOrgV1NexusGetSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public GetNexusForOrgV1NexusGetSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public GetNexusForOrgV1NexusGetSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetNexusForOrgV1NexusGetSecurity other = (GetNexusForOrgV1NexusGetSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetNexusForOrgV1NexusGetSecurity.class,
    ...
    public final static class Builder {
        ...
        public GetNexusForOrgV1NexusGetSecurity build() {

            return new GetNexusForOrgV1NexusGetSecurity(
                apiKeyHeader, httpBearer);
        }
