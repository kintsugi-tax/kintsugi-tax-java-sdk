...
public class GetProductByIdV1ProductsProductIdGetSecurity implements HasSecurity {
    ...
    @JsonCreator
    public GetProductByIdV1ProductsProductIdGetSecurity(
    ...
    public GetProductByIdV1ProductsProductIdGetSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public GetProductByIdV1ProductsProductIdGetSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public GetProductByIdV1ProductsProductIdGetSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public GetProductByIdV1ProductsProductIdGetSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetProductByIdV1ProductsProductIdGetSecurity other = (GetProductByIdV1ProductsProductIdGetSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetProductByIdV1ProductsProductIdGetSecurity.class,
    ...
    public final static class Builder {
        ...
        public GetProductByIdV1ProductsProductIdGetSecurity build() {

            return new GetProductByIdV1ProductsProductIdGetSecurity(
                apiKeyHeader, httpBearer);
        }
