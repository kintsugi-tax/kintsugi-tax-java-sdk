...
public class GetProductCategoriesV1ProductsCategoriesGetResponse implements Response {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetProductCategoriesV1ProductsCategoriesGetResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
