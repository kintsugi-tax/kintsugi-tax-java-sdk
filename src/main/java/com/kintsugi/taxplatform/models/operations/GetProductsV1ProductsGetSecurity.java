...
public class GetProductsV1ProductsGetSecurity implements HasSecurity {
    ...
    @JsonCreator
    public GetProductsV1ProductsGetSecurity(
    ...
    public GetProductsV1ProductsGetSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public GetProductsV1ProductsGetSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public GetProductsV1ProductsGetSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public GetProductsV1ProductsGetSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetProductsV1ProductsGetSecurity other = (GetProductsV1ProductsGetSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetProductsV1ProductsGetSecurity.class,
    ...
    public final static class Builder {
        ...
        public GetProductsV1ProductsGetSecurity build() {

            return new GetProductsV1ProductsGetSecurity(
                apiKeyHeader, httpBearer);
        }
