...
public class GetTransactionByIdV1TransactionsTransactionIdGetSecurity implements HasSecurity {
    ...
    @JsonCreator
    public GetTransactionByIdV1TransactionsTransactionIdGetSecurity(
    ...
    public GetTransactionByIdV1TransactionsTransactionIdGetSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public GetTransactionByIdV1TransactionsTransactionIdGetSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public GetTransactionByIdV1TransactionsTransactionIdGetSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public GetTransactionByIdV1TransactionsTransactionIdGetSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTransactionByIdV1TransactionsTransactionIdGetSecurity other = (GetTransactionByIdV1TransactionsTransactionIdGetSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTransactionByIdV1TransactionsTransactionIdGetSecurity.class,
    ...
    public final static class Builder {
        ...
        public GetTransactionByIdV1TransactionsTransactionIdGetSecurity build() {

            return new GetTransactionByIdV1TransactionsTransactionIdGetSecurity(
                apiKeyHeader, httpBearer);
        }
