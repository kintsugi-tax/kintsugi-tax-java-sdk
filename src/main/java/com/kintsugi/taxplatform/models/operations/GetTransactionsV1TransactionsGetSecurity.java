...
public class GetTransactionsV1TransactionsGetSecurity implements HasSecurity {
    ...
    @JsonCreator
    public GetTransactionsV1TransactionsGetSecurity(
    ...
    public GetTransactionsV1TransactionsGetSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public GetTransactionsV1TransactionsGetSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public GetTransactionsV1TransactionsGetSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public GetTransactionsV1TransactionsGetSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetTransactionsV1TransactionsGetSecurity other = (GetTransactionsV1TransactionsGetSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetTransactionsV1TransactionsGetSecurity.class,
    ...
    public final static class Builder {
        ...
        public GetTransactionsV1TransactionsGetSecurity build() {

            return new GetTransactionsV1TransactionsGetSecurity(
                apiKeyHeader, httpBearer);
        }
