...
public class SuggestionsV1AddressValidationSuggestionsPostSecurity implements HasSecurity {
    ...
    @JsonCreator
    public SuggestionsV1AddressValidationSuggestionsPostSecurity(
    ...
    public SuggestionsV1AddressValidationSuggestionsPostSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public SuggestionsV1AddressValidationSuggestionsPostSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public SuggestionsV1AddressValidationSuggestionsPostSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public SuggestionsV1AddressValidationSuggestionsPostSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SuggestionsV1AddressValidationSuggestionsPostSecurity other = (SuggestionsV1AddressValidationSuggestionsPostSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SuggestionsV1AddressValidationSuggestionsPostSecurity.class,
    ...
    public final static class Builder {
        ...
        public SuggestionsV1AddressValidationSuggestionsPostSecurity build() {

            return new SuggestionsV1AddressValidationSuggestionsPostSecurity(
                apiKeyHeader, httpBearer);
        }
