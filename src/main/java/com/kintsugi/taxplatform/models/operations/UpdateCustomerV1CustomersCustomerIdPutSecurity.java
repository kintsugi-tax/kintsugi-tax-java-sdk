...
public class UpdateCustomerV1CustomersCustomerIdPutSecurity implements HasSecurity {
    ...
    @JsonCreator
    public UpdateCustomerV1CustomersCustomerIdPutSecurity(
    ...
    public UpdateCustomerV1CustomersCustomerIdPutSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public UpdateCustomerV1CustomersCustomerIdPutSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public UpdateCustomerV1CustomersCustomerIdPutSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public UpdateCustomerV1CustomersCustomerIdPutSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateCustomerV1CustomersCustomerIdPutSecurity other = (UpdateCustomerV1CustomersCustomerIdPutSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateCustomerV1CustomersCustomerIdPutSecurity.class,
    ...
    public final static class Builder {
        ...
        public UpdateCustomerV1CustomersCustomerIdPutSecurity build() {

            return new UpdateCustomerV1CustomersCustomerIdPutSecurity(
                apiKeyHeader, httpBearer);
        }
