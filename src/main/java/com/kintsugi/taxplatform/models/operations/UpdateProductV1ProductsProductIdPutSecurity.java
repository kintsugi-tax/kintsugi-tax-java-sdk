...
public class UpdateProductV1ProductsProductIdPutSecurity implements HasSecurity {
    ...
    @JsonCreator
    public UpdateProductV1ProductsProductIdPutSecurity(
    ...
    public UpdateProductV1ProductsProductIdPutSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public UpdateProductV1ProductsProductIdPutSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public UpdateProductV1ProductsProductIdPutSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public UpdateProductV1ProductsProductIdPutSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateProductV1ProductsProductIdPutSecurity other = (UpdateProductV1ProductsProductIdPutSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateProductV1ProductsProductIdPutSecurity.class,
    ...
    public final static class Builder {
        ...
        public UpdateProductV1ProductsProductIdPutSecurity build() {

            return new UpdateProductV1ProductsProductIdPutSecurity(
                apiKeyHeader, httpBearer);
        }
