...
public class UpdateTransactionV1TransactionsTransactionIdPutSecurity implements HasSecurity {
    ...
    @JsonCreator
    public UpdateTransactionV1TransactionsTransactionIdPutSecurity(
    ...
    public UpdateTransactionV1TransactionsTransactionIdPutSecurity withAPIKeyHeader(String apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
    ...
    public UpdateTransactionV1TransactionsTransactionIdPutSecurity withAPIKeyHeader(Optional<String> apiKeyHeader) {
        Utils.checkNotNull(apiKeyHeader, "apiKeyHeader");
        this.apiKeyHeader = apiKeyHeader;
        return this;
    }

    public UpdateTransactionV1TransactionsTransactionIdPutSecurity withHTTPBearer(String httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
    ...
    public UpdateTransactionV1TransactionsTransactionIdPutSecurity withHTTPBearer(Optional<String> httpBearer) {
        Utils.checkNotNull(httpBearer, "httpBearer");
        this.httpBearer = httpBearer;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateTransactionV1TransactionsTransactionIdPutSecurity other = (UpdateTransactionV1TransactionsTransactionIdPutSecurity) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateTransactionV1TransactionsTransactionIdPutSecurity.class,
    ...
    public final static class Builder {
        ...
        public UpdateTransactionV1TransactionsTransactionIdPutSecurity build() {

            return new UpdateTransactionV1TransactionsTransactionIdPutSecurity(
                apiKeyHeader, httpBearer);
        }
