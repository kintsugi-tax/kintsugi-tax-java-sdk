...
import com.kintsugi.taxplatform.models.components.FilingRead;
...
public class ApproveFilingV1FilingsFilingIdApprovePut {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "approve_filing_v1_filings__filing_id__approve_put",
    ...
    public static class Sync extends Base
            implements RequestOperation<ApproveFilingV1FilingsFilingIdApprovePutRequest, ApproveFilingV1FilingsFilingIdApprovePutResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ApproveFilingV1FilingsFilingIdApprovePutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ApproveFilingV1FilingsFilingIdApprovePutRequest.class, new TypeReference<ApproveFilingV1FilingsFilingIdApprovePutRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ApproveFilingV1FilingsFilingIdApprovePutRequest request) {
        ...
        @Override
        public ApproveFilingV1FilingsFilingIdApprovePutResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ApproveFilingV1FilingsFilingIdApprovePutResponse.Builder resBuilder =
            ...
            ApproveFilingV1FilingsFilingIdApprovePutResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFilingRead(Utils.unmarshal(response, new TypeReference<FilingRead>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ApproveFilingV1FilingsFilingIdApprovePutRequest, com.kintsugi.taxplatform.models.operations.async.ApproveFilingV1FilingsFilingIdApprovePutResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ApproveFilingV1FilingsFilingIdApprovePutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ApproveFilingV1FilingsFilingIdApprovePutRequest.class, new TypeReference<ApproveFilingV1FilingsFilingIdApprovePutRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ApproveFilingV1FilingsFilingIdApprovePutRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.ApproveFilingV1FilingsFilingIdApprovePutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.ApproveFilingV1FilingsFilingIdApprovePutResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.ApproveFilingV1FilingsFilingIdApprovePutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.ApproveFilingV1FilingsFilingIdApprovePutResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FilingRead>() {})
                            .thenApply(res::withFilingRead);
                } else {
