...
public class ArchiveTransactionByIdV1TransactionsArchivePost {
    ...
    public static class Sync extends Base
            implements RequestOperation<ArchiveTransactionByIdV1TransactionsArchivePostRequest, ArchiveTransactionByIdV1TransactionsArchivePostResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ArchiveTransactionByIdV1TransactionsArchivePostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ArchiveTransactionByIdV1TransactionsArchivePostRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ArchiveTransactionByIdV1TransactionsArchivePostRequest request) {
        ...
        @Override
        public ArchiveTransactionByIdV1TransactionsArchivePostResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ArchiveTransactionByIdV1TransactionsArchivePostResponse.Builder resBuilder =
                    ArchiveTransactionByIdV1TransactionsArchivePostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            ArchiveTransactionByIdV1TransactionsArchivePostResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ArchiveTransactionByIdV1TransactionsArchivePostRequest, com.kintsugi.taxplatform.models.operations.async.ArchiveTransactionByIdV1TransactionsArchivePostResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ArchiveTransactionByIdV1TransactionsArchivePostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ArchiveTransactionByIdV1TransactionsArchivePostRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ArchiveTransactionByIdV1TransactionsArchivePostRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.ArchiveTransactionByIdV1TransactionsArchivePostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.ArchiveTransactionByIdV1TransactionsArchivePostResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.ArchiveTransactionByIdV1TransactionsArchivePostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.ArchiveTransactionByIdV1TransactionsArchivePostResponse res = resBuilder.build();
