...
public class CreateProductV1ProductsPost {
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.CreateProductV1ProductsPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.CreateProductV1ProductsPostResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.CreateProductV1ProductsPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
