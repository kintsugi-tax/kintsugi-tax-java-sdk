...
public class CreateRegistrationV1RegistrationsPost {
    ...
    public static class Sync extends Base
        ...
        public HttpResponse<InputStream> doRequest(CreateRegistration request) {
            ...
            try {
                ...
                if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "409", "422", "4XX", "500", "5XX")) {
        ...
        @Override
        public CreateRegistrationV1RegistrationsPostResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateRegistrationV1RegistrationsPostResponse.Builder resBuilder =
                    CreateRegistrationV1RegistrationsPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateRegistrationV1RegistrationsPostResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "401", "409")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateRegistration request) {
            return unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "401", "409", "422", "4XX", "500", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.CreateRegistrationV1RegistrationsPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.CreateRegistrationV1RegistrationsPostResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.CreateRegistrationV1RegistrationsPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.CreateRegistrationV1RegistrationsPostResponse res = resBuilder.build();
