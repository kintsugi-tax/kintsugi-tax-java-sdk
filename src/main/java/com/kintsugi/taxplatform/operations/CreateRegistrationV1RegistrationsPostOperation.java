...
public class CreateRegistrationV1RegistrationsPostOperation implements RequestOperation<CreateRegistration, CreateRegistrationV1RegistrationsPostResponse> {
    ...
    public CreateRegistrationV1RegistrationsPostOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(CreateRegistration request) throws Exception {
        ...
        Object convertedRequest = Utils.convertToShape(
                request, 
                JsonShape.DEFAULT,
                new TypeReference<CreateRegistration>() {});
