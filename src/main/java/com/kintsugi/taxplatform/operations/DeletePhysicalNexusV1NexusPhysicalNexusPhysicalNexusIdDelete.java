...
public class DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteRequest, DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteRequest request) throws Exception {
        ...
        @Override
        public DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse.Builder resBuilder =
                    DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteRequest, com.kintsugi.taxplatform.models.operations.async.DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.DeletePhysicalNexusV1NexusPhysicalNexusPhysicalNexusIdDeleteResponse res = resBuilder.build();
