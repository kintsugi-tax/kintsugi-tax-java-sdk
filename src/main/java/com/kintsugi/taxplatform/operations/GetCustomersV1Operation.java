...
public class GetCustomersV1Operation implements RequestOperation<GetCustomersV1Request, GetCustomersV1Response> {
    ...
    public HttpRequest buildRequest(GetCustomersV1Request request) throws Exception {
