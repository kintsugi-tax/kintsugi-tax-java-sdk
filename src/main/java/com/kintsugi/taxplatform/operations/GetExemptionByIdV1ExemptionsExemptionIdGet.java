...
public class GetExemptionByIdV1ExemptionsExemptionIdGet {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetExemptionByIdV1ExemptionsExemptionIdGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExemptionByIdV1ExemptionsExemptionIdGetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetExemptionByIdV1ExemptionsExemptionIdGetRequest request) {
        ...
        @Override
        public GetExemptionByIdV1ExemptionsExemptionIdGetResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetExemptionByIdV1ExemptionsExemptionIdGetRequest, com.kintsugi.taxplatform.models.operations.async.GetExemptionByIdV1ExemptionsExemptionIdGetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetExemptionByIdV1ExemptionsExemptionIdGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExemptionByIdV1ExemptionsExemptionIdGetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetExemptionByIdV1ExemptionsExemptionIdGetRequest request) {
            return unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        if (err != null) {
                            return onError(null, err);
                        }
                        if (Utils.statusCodeMatches(resp.statusCode(), "404", "422", "4XX", "500", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.GetExemptionByIdV1ExemptionsExemptionIdGetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.GetExemptionByIdV1ExemptionsExemptionIdGetResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.GetExemptionByIdV1ExemptionsExemptionIdGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.GetExemptionByIdV1ExemptionsExemptionIdGetResponse res = resBuilder.build();
