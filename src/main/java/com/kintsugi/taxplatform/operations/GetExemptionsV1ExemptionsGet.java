...
public class GetExemptionsV1ExemptionsGet {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetExemptionsV1ExemptionsGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExemptionsV1ExemptionsGetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetExemptionsV1ExemptionsGetRequest request) {
        ...
        @Override
        public GetExemptionsV1ExemptionsGetResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFastapiPaginationDefaultPageExemptionRead2(Utils.unmarshal(response, new TypeReference<FastapiPaginationDefaultPageExemptionRead2>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetExemptionsV1ExemptionsGetRequest, com.kintsugi.taxplatform.models.operations.async.GetExemptionsV1ExemptionsGetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetExemptionsV1ExemptionsGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExemptionsV1ExemptionsGetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetExemptionsV1ExemptionsGetRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.GetExemptionsV1ExemptionsGetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.GetExemptionsV1ExemptionsGetResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.GetExemptionsV1ExemptionsGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.GetExemptionsV1ExemptionsGetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FastapiPaginationDefaultPageExemptionRead2>() {})
                            .thenApply(res::withFastapiPaginationDefaultPageExemptionRead2);
                } else {
