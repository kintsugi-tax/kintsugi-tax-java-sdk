...
public class GetFilingByIdV1FilingsFilingIdGet {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetFilingByIdV1FilingsFilingIdGetRequest, GetFilingByIdV1FilingsFilingIdGetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetFilingByIdV1FilingsFilingIdGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFilingByIdV1FilingsFilingIdGetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFilingByIdV1FilingsFilingIdGetRequest request) {
        ...
        @Override
        public GetFilingByIdV1FilingsFilingIdGetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetFilingByIdV1FilingsFilingIdGetResponse.Builder resBuilder =
            ...
            GetFilingByIdV1FilingsFilingIdGetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFilingDetailsRead(Utils.unmarshal(response, new TypeReference<FilingDetailsRead>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFilingByIdV1FilingsFilingIdGetRequest, com.kintsugi.taxplatform.models.operations.async.GetFilingByIdV1FilingsFilingIdGetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetFilingByIdV1FilingsFilingIdGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFilingByIdV1FilingsFilingIdGetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFilingByIdV1FilingsFilingIdGetRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.GetFilingByIdV1FilingsFilingIdGetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.GetFilingByIdV1FilingsFilingIdGetResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.GetFilingByIdV1FilingsFilingIdGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.GetFilingByIdV1FilingsFilingIdGetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FilingDetailsRead>() {})
                            .thenApply(res::withFilingDetailsRead);
                } else {
