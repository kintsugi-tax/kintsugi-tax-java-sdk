...
public class GetFilingByIdV1FilingsFilingIdGet {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFilingByIdV1FilingsFilingIdGetRequest request) throws Exception {
        ...
        @Override
        public GetFilingByIdV1FilingsFilingIdGetResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    FilingDetailsRead out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withFilingDetailsRead(out);
                    return res;
                } else {
