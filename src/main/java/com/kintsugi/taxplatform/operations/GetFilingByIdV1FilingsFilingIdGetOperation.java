...
public class GetFilingByIdV1FilingsFilingIdGetOperation implements RequestOperation<GetFilingByIdV1FilingsFilingIdGetRequest, GetFilingByIdV1FilingsFilingIdGetResponse> {
    ...
    public GetFilingByIdV1FilingsFilingIdGetOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetFilingByIdV1FilingsFilingIdGetRequest request) throws Exception {
