...
public class GetFilingsByRegistrationIdV1FilingsRegistrationRegistrationIdGetOperation implements RequestOperation<GetFilingsByRegistrationIdV1FilingsRegistrationRegistrationIdGetRequest, GetFilingsByRegistrationIdV1FilingsRegistrationRegistrationIdGetResponse> {
    ...
    public GetFilingsByRegistrationIdV1FilingsRegistrationRegistrationIdGetOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetFilingsByRegistrationIdV1FilingsRegistrationRegistrationIdGetRequest request) throws Exception {
        String url = Utils.generateURL(
                GetFilingsByRegistrationIdV1FilingsRegistrationRegistrationIdGetRequest.class,
                this.baseUrl,
