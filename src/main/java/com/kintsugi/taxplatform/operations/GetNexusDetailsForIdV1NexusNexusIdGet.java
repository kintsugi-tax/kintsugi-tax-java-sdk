...
public class GetNexusDetailsForIdV1NexusNexusIdGet {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "get_nexus_details_for_id_v1_nexus__nexus_id__get",
    ...
    public static class Sync extends Base
            implements RequestOperation<GetNexusDetailsForIdV1NexusNexusIdGetRequest, GetNexusDetailsForIdV1NexusNexusIdGetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetNexusDetailsForIdV1NexusNexusIdGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetNexusDetailsForIdV1NexusNexusIdGetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetNexusDetailsForIdV1NexusNexusIdGetRequest request) {
        ...
        @Override
        public GetNexusDetailsForIdV1NexusNexusIdGetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetNexusDetailsForIdV1NexusNexusIdGetResponse.Builder resBuilder =
                    GetNexusDetailsForIdV1NexusNexusIdGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetNexusDetailsForIdV1NexusNexusIdGetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withNexusResponse(Utils.unmarshal(response, new TypeReference<NexusResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetNexusDetailsForIdV1NexusNexusIdGetRequest, com.kintsugi.taxplatform.models.operations.async.GetNexusDetailsForIdV1NexusNexusIdGetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetNexusDetailsForIdV1NexusNexusIdGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetNexusDetailsForIdV1NexusNexusIdGetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetNexusDetailsForIdV1NexusNexusIdGetRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.GetNexusDetailsForIdV1NexusNexusIdGetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.GetNexusDetailsForIdV1NexusNexusIdGetResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.GetNexusDetailsForIdV1NexusNexusIdGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.GetNexusDetailsForIdV1NexusNexusIdGetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<NexusResponse>() {})
                            .thenApply(res::withNexusResponse);
                } else {
