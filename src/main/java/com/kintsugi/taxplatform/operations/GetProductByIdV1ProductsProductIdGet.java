...
public class GetProductByIdV1ProductsProductIdGet {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetProductByIdV1ProductsProductIdGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProductByIdV1ProductsProductIdGetRequest.class);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetProductByIdV1ProductsProductIdGetRequest, com.kintsugi.taxplatform.models.operations.async.GetProductByIdV1ProductsProductIdGetResponse> {

        public Async(SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetProductByIdV1ProductsProductIdGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProductByIdV1ProductsProductIdGetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetProductByIdV1ProductsProductIdGetRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.GetProductByIdV1ProductsProductIdGetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.GetProductByIdV1ProductsProductIdGetResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.GetProductByIdV1ProductsProductIdGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.GetProductByIdV1ProductsProductIdGetResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.kintsugi.taxplatform.models.errors.async.BackendSrcProductsResponsesValidationErrorResponse out;
                        try {
                            out = Utils.mapper().readValue(
                                    bodyBytes,
                                    new TypeReference<>() {
