...
public class GetProductsV1ProductsGet {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetProductsV1ProductsGetRequest, GetProductsV1ProductsGetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetProductsV1ProductsGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProductsV1ProductsGetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProductsV1ProductsGetRequest request) throws Exception {
        ...
        @Override
        public GetProductsV1ProductsGetResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetProductsV1ProductsGetResponse.Builder resBuilder =
                    GetProductsV1ProductsGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetProductsV1ProductsGetResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PageProductRead out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPageProductRead(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetProductsV1ProductsGetRequest, com.kintsugi.taxplatform.models.operations.async.GetProductsV1ProductsGetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetProductsV1ProductsGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProductsV1ProductsGetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetProductsV1ProductsGetRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.GetProductsV1ProductsGetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.GetProductsV1ProductsGetResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.GetProductsV1ProductsGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.GetProductsV1ProductsGetResponse res = resBuilder.build();
