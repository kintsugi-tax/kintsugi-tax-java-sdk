...
public class GetProductsV1ProductsGet {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProductsV1ProductsGetRequest request) {
        ...
        @Override
        public GetProductsV1ProductsGetResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPageProductRead(Utils.unmarshal(response, new TypeReference<PageProductRead>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.GetProductsV1ProductsGetResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PageProductRead>() {})
                            .thenApply(res::withPageProductRead);
                } else {
