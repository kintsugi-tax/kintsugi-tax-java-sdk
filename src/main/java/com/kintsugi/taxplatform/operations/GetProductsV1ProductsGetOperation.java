...
public class GetProductsV1ProductsGetOperation implements RequestOperation<GetProductsV1ProductsGetRequest, GetProductsV1ProductsGetResponse> {
    ...
    public HttpRequest buildRequest(GetProductsV1ProductsGetRequest request) throws Exception {
