...
public class GetRegistrationByIdV1RegistrationsRegistrationIdGetOperation implements RequestOperation<GetRegistrationByIdV1RegistrationsRegistrationIdGetRequest, GetRegistrationByIdV1RegistrationsRegistrationIdGetResponse> {
    ...
    public GetRegistrationByIdV1RegistrationsRegistrationIdGetOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetRegistrationByIdV1RegistrationsRegistrationIdGetRequest request) throws Exception {
        String url = Utils.generateURL(
                GetRegistrationByIdV1RegistrationsRegistrationIdGetRequest.class,
                this.baseUrl,
