...
public class GetRegistrationsV1RegistrationsGet {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRegistrationsV1RegistrationsGetRequest request) {
        ...
        @Override
        public GetRegistrationsV1RegistrationsGetResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPageRegistrationReadWithPassword(Utils.unmarshal(response, new TypeReference<PageRegistrationReadWithPassword>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.GetRegistrationsV1RegistrationsGetResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PageRegistrationReadWithPassword>() {})
                            .thenApply(res::withPageRegistrationReadWithPassword);
                } else {
