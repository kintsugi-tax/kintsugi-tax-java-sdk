...
public class GetRegistrationsV1RegistrationsGetOperation implements RequestOperation<GetRegistrationsV1RegistrationsGetRequest, GetRegistrationsV1RegistrationsGetResponse> {
    ...
    public GetRegistrationsV1RegistrationsGetOperation(SDKConfiguration sdkConfiguration) {
    ...
    public HttpRequest buildRequest(GetRegistrationsV1RegistrationsGetRequest request) throws Exception {
        ...
        req.addQueryParams(Utils.getQueryParams(
                GetRegistrationsV1RegistrationsGetRequest.class,
                request, 
                null));
