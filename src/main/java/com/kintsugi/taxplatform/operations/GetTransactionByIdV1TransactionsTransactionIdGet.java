...
public class GetTransactionByIdV1TransactionsTransactionIdGet {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTransactionByIdV1TransactionsTransactionIdGetRequest, GetTransactionByIdV1TransactionsTransactionIdGetResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTransactionByIdV1TransactionsTransactionIdGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransactionByIdV1TransactionsTransactionIdGetRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTransactionByIdV1TransactionsTransactionIdGetRequest request) {
        ...
        @Override
        public GetTransactionByIdV1TransactionsTransactionIdGetResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTransactionByIdV1TransactionsTransactionIdGetResponse.Builder resBuilder =
                    GetTransactionByIdV1TransactionsTransactionIdGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetTransactionByIdV1TransactionsTransactionIdGetResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTransactionByIdV1TransactionsTransactionIdGetRequest, com.kintsugi.taxplatform.models.operations.async.GetTransactionByIdV1TransactionsTransactionIdGetResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTransactionByIdV1TransactionsTransactionIdGetRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransactionByIdV1TransactionsTransactionIdGetRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTransactionByIdV1TransactionsTransactionIdGetRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.GetTransactionByIdV1TransactionsTransactionIdGetResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.GetTransactionByIdV1TransactionsTransactionIdGetResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.GetTransactionByIdV1TransactionsTransactionIdGetResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.GetTransactionByIdV1TransactionsTransactionIdGetResponse res = resBuilder.build();
