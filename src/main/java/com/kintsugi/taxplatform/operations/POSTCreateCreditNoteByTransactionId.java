...
public class POSTCreateCreditNoteByTransactionId {
    ...
    public static class Sync extends Base
            implements RequestOperation<POSTCreateCreditNoteByTransactionIdRequest, POSTCreateCreditNoteByTransactionIdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(POSTCreateCreditNoteByTransactionIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, POSTCreateCreditNoteByTransactionIdRequest.class, new TypeReference<POSTCreateCreditNoteByTransactionIdRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(POSTCreateCreditNoteByTransactionIdRequest request) {
        ...
        @Override
        public POSTCreateCreditNoteByTransactionIdResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<POSTCreateCreditNoteByTransactionIdRequest, com.kintsugi.taxplatform.models.operations.async.POSTCreateCreditNoteByTransactionIdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(POSTCreateCreditNoteByTransactionIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, POSTCreateCreditNoteByTransactionIdRequest.class, new TypeReference<POSTCreateCreditNoteByTransactionIdRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(POSTCreateCreditNoteByTransactionIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.POSTCreateCreditNoteByTransactionIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.POSTCreateCreditNoteByTransactionIdResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.POSTCreateCreditNoteByTransactionIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.POSTCreateCreditNoteByTransactionIdResponse res = resBuilder.build();
