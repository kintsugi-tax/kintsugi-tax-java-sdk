...
public class SearchV1AddressValidationSearchPost {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddressBase request) {
        ...
        @Override
        public SearchV1AddressValidationSearchPostResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResponse200SearchV1AddressValidationSearchPost(Utils.unmarshal(response, new TypeReference<List<AddressSearchResponse>>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.SearchV1AddressValidationSearchPostResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AddressSearchResponse>>() {})
                            .thenApply(res::withResponse200SearchV1AddressValidationSearchPost);
                } else {
