...
public class SearchV1AddressValidationSearchPostOperation implements RequestOperation<AddressBase, SearchV1AddressValidationSearchPostResponse> {

    private final SDKConfiguration sdkConfiguration;
    private final String baseUrl;
    private final SearchV1AddressValidationSearchPostSecurity security;
    private final SecuritySource securitySource;
    private final HTTPClient client;

    public SearchV1AddressValidationSearchPostOperation(
        SDKConfiguration sdkConfiguration,
        SearchV1AddressValidationSearchPostSecurity security) {
    ...
    public HttpRequest buildRequest(AddressBase request) throws Exception {
