...
public class UpdateProductV1ProductsProductIdPut {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateProductV1ProductsProductIdPutRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateProductV1ProductsProductIdPutRequest.class, new TypeReference<UpdateProductV1ProductsProductIdPutRequest>() {});
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateProductV1ProductsProductIdPutRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.UpdateProductV1ProductsProductIdPutResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.UpdateProductV1ProductsProductIdPutResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.UpdateProductV1ProductsProductIdPutResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.UpdateProductV1ProductsProductIdPutResponse res = resBuilder.build();
