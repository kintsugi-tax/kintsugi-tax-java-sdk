...
public class UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPost {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostRequest.class, new TypeReference<UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostRequest request) {
        ...
        @Override
        public UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttachmentRead(Utils.unmarshal(response, new TypeReference<AttachmentRead>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostRequest, com.kintsugi.taxplatform.models.operations.async.UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostRequest.class, new TypeReference<UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostRequest request) {
        ...
        @Override
        public CompletableFuture<com.kintsugi.taxplatform.models.operations.async.UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.kintsugi.taxplatform.models.operations.async.UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostResponse.Builder resBuilder =
                    com.kintsugi.taxplatform.models.operations.async.UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.kintsugi.taxplatform.models.operations.async.UploadExemptionCertificateV1ExemptionsExemptionIdAttachmentsPostResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttachmentRead>() {})
                            .thenApply(res::withAttachmentRead);
                } else {
