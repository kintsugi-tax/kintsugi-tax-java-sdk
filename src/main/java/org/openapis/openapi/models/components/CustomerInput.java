...
public class CustomerInput {
    ...
    public CustomerInput(
        ...
        this(Optional.empty(), Optional.empty(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), Optional.empty(), JsonNullable.undefined(), Optional.empty(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), JsonNullable.undefined(), organizationId, Optional.empty());
    }
    ...
    public CustomerInput withId(Optional<String> id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Timestamp when transaction was created in Kintsugi.
     */
    public CustomerInput withCreatedAt(OffsetDateTime createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
     ...
     * Timestamp when transaction was created in Kintsugi.
     */
    public CustomerInput withCreatedAt(Optional<OffsetDateTime> createdAt) {
        Utils.checkNotNull(createdAt, "createdAt");
        this.createdAt = createdAt;
        return this;
    }
     ...
     * Timestamp when transaction was last updated.
     */
    public CustomerInput withUpdatedAt(OffsetDateTime updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
     ...
     * Timestamp when transaction was last updated.
     */
    public CustomerInput withUpdatedAt(JsonNullable<OffsetDateTime> updatedAt) {
        Utils.checkNotNull(updatedAt, "updatedAt");
        this.updatedAt = updatedAt;
        return this;
    }
     ...
     * Phone number associated with the address.
     */
    public CustomerInput withPhone(String phone) {
        Utils.checkNotNull(phone, "phone");
     ...
     * Phone number associated with the address.
     */
    public CustomerInput withPhone(JsonNullable<String> phone) {
        Utils.checkNotNull(phone, "phone");
        this.phone = phone;
        return this;
    }
     ...
     * Primary street address.
     */
    public CustomerInput withStreet1(String street1) {
        Utils.checkNotNull(street1, "street1");
     ...
     * Primary street address.
     */
    public CustomerInput withStreet1(JsonNullable<String> street1) {
        Utils.checkNotNull(street1, "street1");
        this.street1 = street1;
        return this;
    }
     ...
     * Additional street address details, such as an apartment or suite number.
     */
    public CustomerInput withStreet2(String street2) {
        Utils.checkNotNull(street2, "street2");
     ...
     * Additional street address details, such as an apartment or suite number.
     */
    public CustomerInput withStreet2(JsonNullable<String> street2) {
        Utils.checkNotNull(street2, "street2");
        this.street2 = street2;
        return this;
    }
     ...
     * City where the customer resides.
     */
    public CustomerInput withCity(String city) {
        Utils.checkNotNull(city, "city");
     ...
     * City where the customer resides.
     */
    public CustomerInput withCity(JsonNullable<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }
     ...
     * County or district of the customer.
     */
    public CustomerInput withCounty(String county) {
        Utils.checkNotNull(county, "county");
     ...
     * County or district of the customer.
     */
    public CustomerInput withCounty(JsonNullable<String> county) {
        Utils.checkNotNull(county, "county");
        this.county = county;
        return this;
    }
     ...
     * State or province of the customer.
     */
    public CustomerInput withState(String state) {
        Utils.checkNotNull(state, "state");
     ...
     * State or province of the customer.
     */
    public CustomerInput withState(JsonNullable<String> state) {
        Utils.checkNotNull(state, "state");
        this.state = state;
        return this;
    }
     ...
     * ZIP or Postal code of the customer.
     */
    public CustomerInput withPostalCode(String postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
     ...
     * ZIP or Postal code of the customer.
     */
    public CustomerInput withPostalCode(JsonNullable<String> postalCode) {
        Utils.checkNotNull(postalCode, "postalCode");
        this.postalCode = postalCode;
        return this;
    }
     ...
     * Country code in ISO 3166-1 alpha-2 format
     */
    public CustomerInput withCountry(CountryCodeEnum country) {
        Utils.checkNotNull(country, "country");
     ...
     * Country code in ISO 3166-1 alpha-2 format
     */
    public CustomerInput withCountry(JsonNullable<? extends CountryCodeEnum> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
     ...
     * Complete address string of the customer, which can be used as an alternative to individual fields.
     */
    public CustomerInput withFullAddress(String fullAddress) {
        Utils.checkNotNull(fullAddress, "fullAddress");
     ...
     * Complete address string of the customer, which can be used as an alternative to individual fields.
     */
    public CustomerInput withFullAddress(JsonNullable<String> fullAddress) {
        Utils.checkNotNull(fullAddress, "fullAddress");
        this.fullAddress = fullAddress;
        return this;
    }
     ...
     * Name of the customer.
     */
    public CustomerInput withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * Name of the customer.
     */
    public CustomerInput withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * A unique identifier for the customer.
     */
    public CustomerInput withExternalId(String externalId) {
        Utils.checkNotNull(externalId, "externalId");
     ...
     * A unique identifier for the customer.
     */
    public CustomerInput withExternalId(JsonNullable<String> externalId) {
        Utils.checkNotNull(externalId, "externalId");
        this.externalId = externalId;
        return this;
    }

    public CustomerInput withStatus(StatusEnum status) {
        Utils.checkNotNull(status, "status");
        this.status = Optional.ofNullable(status);
        return this;
    }

    public CustomerInput withStatus(Optional<? extends StatusEnum> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * Email address of the customer.
     */
    public CustomerInput withEmail(JsonNullable<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }

    public CustomerInput withAddressStatus(AddressStatus addressStatus) {
        Utils.checkNotNull(addressStatus, "addressStatus");
        this.addressStatus = Optional.ofNullable(addressStatus);
        return this;
    }

    public CustomerInput withAddressStatus(Optional<? extends AddressStatus> addressStatus) {
        Utils.checkNotNull(addressStatus, "addressStatus");
        this.addressStatus = addressStatus;
        return this;
    }
     ...
     * Source of the customer information (e.g., BIGCOMMERCE, STRIPE, etc.).
     */
    public CustomerInput withSource(SourceEnum source) {
        Utils.checkNotNull(source, "source");
     ...
     * Source of the customer information (e.g., BIGCOMMERCE, STRIPE, etc.).
     */
    public CustomerInput withSource(JsonNullable<? extends SourceEnum> source) {
        Utils.checkNotNull(source, "source");
        this.source = source;
        return this;
    }

    public CustomerInput withRegistrationNumber(String registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
        this.registrationNumber = JsonNullable.of(registrationNumber);
        return this;
    }

    public CustomerInput withRegistrationNumber(JsonNullable<String> registrationNumber) {
        Utils.checkNotNull(registrationNumber, "registrationNumber");
        this.registrationNumber = registrationNumber;
        return this;
    }

    public CustomerInput withConnectionId(String connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = JsonNullable.of(connectionId);
        return this;
    }

    public CustomerInput withConnectionId(JsonNullable<String> connectionId) {
        Utils.checkNotNull(connectionId, "connectionId");
        this.connectionId = connectionId;
        return this;
    }
     ...
     * Additional enriched fields for the customer, if available.
     */
    public CustomerInput withEnrichedFields(String enrichedFields) {
        Utils.checkNotNull(enrichedFields, "enrichedFields");
     ...
     * Additional enriched fields for the customer, if available.
     */
    public CustomerInput withEnrichedFields(JsonNullable<String> enrichedFields) {
        Utils.checkNotNull(enrichedFields, "enrichedFields");
        this.enrichedFields = enrichedFields;
        return this;
    }

    public CustomerInput withOrganizationId(String organizationId) {
        Utils.checkNotNull(organizationId, "organizationId");
        this.organizationId = organizationId;
        return this;
    }

    public CustomerInput withIsTestData(boolean isTestData) {
        Utils.checkNotNull(isTestData, "isTestData");
        this.isTestData = Optional.ofNullable(isTestData);
        return this;
    }

    public CustomerInput withIsTestData(Optional<Boolean> isTestData) {
        Utils.checkNotNull(isTestData, "isTestData");
        this.isTestData = isTestData;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Objects.deepEquals(this.fullAddress, other.fullAddress) &&
            Objects.deepEquals(this.name, other.name) &&
            Objects.deepEquals(this.externalId, other.externalId) &&
            Objects.deepEquals(this.status, other.status) &&
            Objects.deepEquals(this.email, other.email) &&
            Objects.deepEquals(this.addressStatus, other.addressStatus) &&
            Objects.deepEquals(this.source, other.source) &&
            Objects.deepEquals(this.registrationNumber, other.registrationNumber) &&
            Objects.deepEquals(this.connectionId, other.connectionId) &&
            Objects.deepEquals(this.enrichedFields, other.enrichedFields) &&
            Objects.deepEquals(this.organizationId, other.organizationId) &&
            Objects.deepEquals(this.isTestData, other.isTestData);
    }
